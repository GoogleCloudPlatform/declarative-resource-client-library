...
func (c *Client) brandDiffsForRawDesired(ctx context.Context, rawDesired *Brand, opts ...dcl.ApplyOption) (initial, desired *Brand, diffs []brandDiff, err error) {
...
func diffBrand(c *Client, desired, actual *Brand, opts ...dcl.ApplyOption) ([]brandDiff, error) {
