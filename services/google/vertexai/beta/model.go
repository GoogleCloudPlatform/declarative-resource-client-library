...
func (r *Model) ID() (string, error) {
	...
	params := map[string]interface{}{
		...
		"versionAliases":                    dcl.ValueOrEmptyString(nr.VersionAliases),
		"versionCreateTime":                 dcl.ValueOrEmptyString(nr.VersionCreateTime),
		"versionUpdateTime":                 dcl.ValueOrEmptyString(nr.VersionUpdateTime),
		"displayName":                       dcl.ValueOrEmptyString(nr.DisplayName),
		"description":                       dcl.ValueOrEmptyString(nr.Description),
		"versionDescription":                dcl.ValueOrEmptyString(nr.VersionDescription),
		"supportedExportFormats":            dcl.ValueOrEmptyString(nr.SupportedExportFormats),
		"trainingPipeline":                  dcl.ValueOrEmptyString(nr.TrainingPipeline),
		"originalModelInfo":                 dcl.ValueOrEmptyString(nr.OriginalModelInfo),
		"containerSpec":                     dcl.ValueOrEmptyString(nr.ContainerSpec),
		"artifactUri":                       dcl.ValueOrEmptyString(nr.ArtifactUri),
		"supportedDeploymentResourcesTypes": dcl.ValueOrEmptyString(nr.SupportedDeploymentResourcesTypes),
		"supportedInputStorageFormats":      dcl.ValueOrEmptyString(nr.SupportedInputStorageFormats),
		"supportedOutputStorageFormats":     dcl.ValueOrEmptyString(nr.SupportedOutputStorageFormats),
...
func applyModelDiff(c *Client, ctx context.Context, desired *Model, rawDesired *Model, ops []modelApiOperation, opts ...dcl.ApplyOption) (*Model, error) {
	...
	rawNew, err := c.GetModel(ctx, desired.urlNormalized())
	if err != nil {
		return nil, err
	}
