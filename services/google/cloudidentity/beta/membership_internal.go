...
func flattenMembership(c *Client, i interface{}) *Membership {
	...
	res.MemberKey = flattenMembershipMemberKey(c, m["memberKey"])
...
// request object.
func expandMembershipMemberKeyMap(c *Client, f map[string]MembershipMemberKey) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandMembershipMemberKey(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// request object.
func expandMembershipMemberKeySlice(c *Client, f []MembershipMemberKey) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// response object.
func flattenMembershipMemberKeyMap(c *Client, i interface{}) map[string]MembershipMemberKey {
	a, ok := i.(map[string]interface{})
	if !ok {
	...
	for k, item := range a {
		items[k] = *flattenMembershipMemberKey(c, item.(map[string]interface{}))
	}
...
// response object.
func flattenMembershipMemberKeySlice(c *Client, i interface{}) []MembershipMemberKey {
	a, ok := i.([]interface{})
	if !ok {
	...
	for _, item := range a {
		items = append(items, *flattenMembershipMemberKey(c, item.(map[string]interface{})))
	}
...
// request object.
func expandMembershipMemberKey(c *Client, f *MembershipMemberKey) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}
...
// response object.
func flattenMembershipMemberKey(c *Client, i interface{}) *MembershipMemberKey {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}
