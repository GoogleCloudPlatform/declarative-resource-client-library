...
func clientTlsPolicyGetURL(userBasePath string, r *ClientTlsPolicy) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/clientTlsPolicies/{{name}}", "https://networksecurity.googleapis.com/v1beta1/", userBasePath, params), nil
}
...
func clientTlsPolicyListURL(userBasePath, project, location string) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/clientTlsPolicies", "https://networksecurity.googleapis.com/v1beta1/", userBasePath, params), nil
...
func clientTlsPolicyCreateURL(userBasePath, project, location, name string) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/clientTlsPolicies?clientTlsPolicyId={{name}}", "https://networksecurity.googleapis.com/v1beta1/", userBasePath, params), nil
...
func (r *ClientTlsPolicy) SetPolicyURL(userBasePath string) string {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/clientTlsPolicies/{{name}}:setIamPolicy", "https://networksecurity.googleapis.com/v1beta1/", userBasePath, fields)
}
...
func (r *ClientTlsPolicy) getPolicyURL(userBasePath string) string {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/clientTlsPolicies/{{name}}:getIamPolicy", "https://networksecurity.googleapis.com/v1beta1/", userBasePath, fields)
}
...
func diffClientTlsPolicy(c *Client, desired, actual *ClientTlsPolicy, opts ...dcl.ApplyOption) ([]clientTlsPolicyDiff, error) {
	...
	if d, err := dcl.Diff(desired.Name, actual.Name, &dcl.Info{Ignore: false, OutputOnly: false, IgnoredPrefixes: []string(nil), Type: ""}); d || err != nil {
		...
		diffs = append(diffs, clientTlsPolicyDiff{RequiresRecreate: true, FieldName: "Name"})
	}
	...
	if d, err := dcl.Diff(desired.Description, actual.Description, &dcl.Info{Ignore: false, OutputOnly: false, IgnoredPrefixes: []string(nil), Type: ""}); d || err != nil {
		...
		diffs = append(diffs, clientTlsPolicyDiff{
			UpdateOp: &updateClientTlsPolicyUpdateClientTlsPolicyOperation{}, FieldName: "Description",
		})
	}
	...
	if d, err := dcl.Diff(desired.CreateTime, actual.CreateTime, &dcl.Info{Ignore: false, OutputOnly: true, IgnoredPrefixes: []string(nil), Type: ""}); d || err != nil {
		...
		diffs = append(diffs, clientTlsPolicyDiff{RequiresRecreate: true, FieldName: "CreateTime"})
	}
	...
	if d, err := dcl.Diff(desired.UpdateTime, actual.UpdateTime, &dcl.Info{Ignore: false, OutputOnly: true, IgnoredPrefixes: []string(nil), Type: ""}); d || err != nil {
		...
		diffs = append(diffs, clientTlsPolicyDiff{RequiresRecreate: true, FieldName: "UpdateTime"})
	}
	...
	if d, err := dcl.Diff(desired.Labels, actual.Labels, &dcl.Info{Ignore: false, OutputOnly: false, IgnoredPrefixes: []string(nil), Type: ""}); d || err != nil {
		...
		diffs = append(diffs, clientTlsPolicyDiff{
			UpdateOp: &updateClientTlsPolicyUpdateClientTlsPolicyOperation{}, FieldName: "Labels",
		})
	}

	if d, err := dcl.Diff(desired.Sni, actual.Sni, &dcl.Info{Ignore: false, OutputOnly: false, IgnoredPrefixes: []string(nil), Type: ""}); d || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, clientTlsPolicyDiff{
			UpdateOp: &updateClientTlsPolicyUpdateClientTlsPolicyOperation{}, FieldName: "Sni",
		})
	}
	...
	if !dcl.IsZeroValue(desired.Description) && !dcl.StringCanonicalize(desired.Description, actual.Description) {
		...
		diffs = append(diffs, clientTlsPolicyDiff{
			UpdateOp:  &updateClientTlsPolicyUpdateClientTlsPolicyOperation{},
	...
	if !dcl.IsZeroValue(desired.Sni) && !dcl.StringCanonicalize(desired.Sni, actual.Sni) {
		c.Config.Logger.Infof("Detected diff in Sni.\nDESIRED: %v\nACTUAL: %v", desired.Sni, actual.Sni)
	...
	if compareClientTlsPolicyClientCertificate(c, desired.ClientCertificate, actual.ClientCertificate) {
		c.Config.Logger.Infof("Detected diff in ClientCertificate.\nDESIRED: %v\nACTUAL: %v", desired.ClientCertificate, actual.ClientCertificate)
	...
	if compareClientTlsPolicyServerValidationCaSlice(c, desired.ServerValidationCa, actual.ServerValidationCa) {
		c.Config.Logger.Infof("Detected diff in ServerValidationCa.\nDESIRED: %v\nACTUAL: %v", desired.ServerValidationCa, actual.ServerValidationCa)
...
func (r *ClientTlsPolicy) urlNormalized() *ClientTlsPolicy {
	normalized := deepcopy.Copy(*r).(ClientTlsPolicy)
...
func (r *ClientTlsPolicy) updateURL(userBasePath, updateName string) (string, error) {
	...
	if updateName == "UpdateClientTlsPolicy" {
		...
		return dcl.URL("projects/{{project}}/locations/{{location}}/clientTlsPolicies/{{name}}", "https://networksecurity.googleapis.com/v1beta1/", userBasePath, fields), nil
