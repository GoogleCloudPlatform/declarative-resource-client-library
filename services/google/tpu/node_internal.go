...
func (op *deleteNodeOperation) do(ctx context.Context, r *Node, c *Client) error {
	r, err := c.GetNode(ctx, r.URLNormalized())
	if err != nil {
...
func (c *Client) nodeDiffsForRawDesired(ctx context.Context, rawDesired *Node, opts ...dcl.ApplyOption) (initial, desired *Node, diffs []*dcl.FieldDiff, err error) {
...
func diffNode(c *Client, desired, actual *Node, opts ...dcl.ApplyOption) ([]*dcl.FieldDiff, error) {
