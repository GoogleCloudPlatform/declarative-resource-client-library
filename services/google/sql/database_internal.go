...
func databaseGetURL(userBasePath string, r *Database) string {
	params := map[string]interface{}{
		"project":  dcl.ValueOrEmptyString(r.Project),
		"instance": dcl.ValueOrEmptyString(r.Instance),
		"name":     dcl.ValueOrEmptyString(r.Name),
	}
	return dcl.URL("projects/{{project}}/instances/{{instance}}/databases/{{name}}", "https://www.googleapis.com/sql/v1beta4/", userBasePath, params)
}

func databaseListURL(userBasePath, project, instance string) string {
	params := map[string]interface{}{
		"project":  project,
		"instance": instance,
	}
	return dcl.URL("projects/{{project}}/instances/{{instance}}/databases", "https://www.googleapis.com/sql/v1beta4/", userBasePath, params)
}

func databaseCreateURL(userBasePath, project, instance string) string {
	params := map[string]interface{}{
		"project":  project,
		"instance": instance,
	}
...
func databaseDeleteURL(userBasePath string, r *Database) string {
	params := map[string]interface{}{
		"project":  dcl.ValueOrEmptyString(r.Project),
		"instance": dcl.ValueOrEmptyString(r.Instance),
		"name":     dcl.ValueOrEmptyString(r.Name),
...
func (c *Client) listDatabaseRaw(ctx context.Context, project, instance, pageToken string, pageSize int32) ([]byte, error) {
	u := databaseListURL(c.Config.BasePath, project, instance)
...
func (op *deleteDatabaseOperation) do(ctx context.Context, r *Database, c *Client) error {
	...
	u := databaseDeleteURL(c.Config.BasePath, r.urlNormalized())
...
func (op *createDatabaseOperation) do(ctx context.Context, r *Database, c *Client) error {
	...
	u := databaseCreateURL(c.Config.BasePath, project, instance)
...
func (c *Client) getDatabaseRaw(ctx context.Context, r *Database) ([]byte, error) {
	u := databaseGetURL(c.Config.BasePath, r.urlNormalized())
	resp, err := dcl.SendRequest(ctx, c.Config, "GET", u, &bytes.Buffer{}, c.Config.Retry)
	if err != nil {
		return nil, err
	}
...
func canonicalizeDatabaseDesiredState(rawDesired, rawInitial *Database) (*Database, error) {
...
func canonicalizeDatabaseNewState(rawNew, rawDesired *Database) (*Database, error) {
