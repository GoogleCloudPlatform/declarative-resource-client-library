...
func sslCertGetURL(userBasePath string, r *SslCert) string {
	params := map[string]interface{}{
		"project":  dcl.ValueOrEmptyString(r.Project),
		"instance": dcl.ValueOrEmptyString(r.Instance),
		"name":     dcl.ValueOrEmptyString(r.Name),
	}
	return dcl.URL("projects/{{project}}/instances/{{instance}}/sslCerts/{{name}}", "https://www.googleapis.com/sql/v1beta4/", userBasePath, params)
}

func sslCertListURL(userBasePath, project, instance string) string {
	params := map[string]interface{}{
		"project":  project,
		"instance": instance,
	}
	return dcl.URL("projects/{{project}}/instances/{{instance}}/sslCerts", "https://www.googleapis.com/sql/v1beta4/", userBasePath, params)
}

func sslCertCreateURL(userBasePath, project, instance string) string {
	params := map[string]interface{}{
		"project":  project,
		"instance": instance,
	}
...
func sslCertDeleteURL(userBasePath string, r *SslCert) string {
	params := map[string]interface{}{
		"project":  dcl.ValueOrEmptyString(r.Project),
		"instance": dcl.ValueOrEmptyString(r.Instance),
		"name":     dcl.ValueOrEmptyString(r.Name),
...
func (c *Client) listSslCertRaw(ctx context.Context, project, instance, pageToken string, pageSize int32) ([]byte, error) {
	u := sslCertListURL(c.Config.BasePath, project, instance)
...
func (op *deleteSslCertOperation) do(ctx context.Context, r *SslCert, c *Client) error {
	...
	u := sslCertDeleteURL(c.Config.BasePath, r.urlNormalized())
...
func (op *createSslCertOperation) do(ctx context.Context, r *SslCert, c *Client) error {
	...
	u := sslCertCreateURL(c.Config.BasePath, project, instance)
...
func (c *Client) getSslCertRaw(ctx context.Context, r *SslCert) ([]byte, error) {
	u := sslCertGetURL(c.Config.BasePath, r.urlNormalized())
	resp, err := dcl.SendRequest(ctx, c.Config, "GET", u, &bytes.Buffer{}, c.Config.Retry)
	if err != nil {
		return nil, err
	}
...
func (c *Client) sslCertDiffsForRawDesired(ctx context.Context, rawDesired *SslCert, opts ...dcl.ApplyOption) (initial, desired *SslCert, diffs []sslCertDiff, err error) {
...
func canonicalizeSslCertDesiredState(rawDesired, rawInitial *SslCert) (*SslCert, error) {
...
func canonicalizeSslCertNewState(rawNew, rawDesired *SslCert) (*SslCert, error) {
...
func diffSslCert(c *Client, desired, actual *SslCert, opts ...dcl.ApplyOption) ([]sslCertDiff, error) {
