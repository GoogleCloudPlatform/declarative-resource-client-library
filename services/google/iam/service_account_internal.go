...
func (c *Client) serviceAccountDiffsForRawDesired(ctx context.Context, rawDesired *ServiceAccount, opts ...dcl.ApplyOption) (initial, desired *ServiceAccount, diffs []serviceAccountDiff, err error) {
...
func diffServiceAccount(c *Client, desired, actual *ServiceAccount, opts ...dcl.ApplyOption) ([]serviceAccountDiff, error) {
	...
	var opTypes []string
	var deduped []serviceAccountDiff
	for _, d := range diffs {
