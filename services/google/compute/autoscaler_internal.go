...
func autoscalerGetURL(userBasePath string, r *Autoscaler) (string, error) {
	...
	if dcl.IsRegion(r.Location) {
		return dcl.URL("projects/{{project}}/regions/{{location}}/autoscalers/{{name}}", "https://www.googleapis.com/compute/v1/", userBasePath, params), nil
	}

	if dcl.IsZone(r.Location) {
		return dcl.URL("projects/{{project}}/zones/{{location}}/autoscalers/{{name}}", "https://www.googleapis.com/compute/v1/", userBasePath, params), nil
	}
...
func autoscalerListURL(userBasePath, project, location string) (string, error) {
	...
	if dcl.IsRegion(&location) {
		return dcl.URL("projects/{{project}}/regions/{{location}}/autoscalers", "https://www.googleapis.com/compute/v1/", userBasePath, params), nil
	}

	if dcl.IsZone(&location) {
		return dcl.URL("projects/{{project}}/zones/{{location}}/autoscalers", "https://www.googleapis.com/compute/v1/", userBasePath, params), nil
	}
...
func (r *Autoscaler) updateURL(userBasePath, updateName string) (string, error) {
	...
	if updateName == "Update" {
		...
		if dcl.IsRegion(r.Location) {
			return dcl.URL("projects/{{project}}/regions/{{location}}/autoscalers?autoscaler={{name}}", "https://www.googleapis.com/compute/v1/", userBasePath, fields), nil
		}

		if dcl.IsZone(r.Location) {
			return dcl.URL("projects/{{project}}/zones/{{location}}/autoscalers?autoscaler={{name}}", "https://www.googleapis.com/compute/v1/", userBasePath, fields), nil
		}
