...
func sslCertificateGetURL(userBasePath string, r *SslCertificate) (string, error) {
	...
	if dcl.IsRegion(r.Location) {
		return dcl.URL("projects/{{project}}/regions/{{location}}/sslCertificates/{{name}}", "https://www.googleapis.com/compute/beta/", userBasePath, params), nil
	}
...
func sslCertificateListURL(userBasePath, project, location string) (string, error) {
	...
	if dcl.IsRegion(&location) {
		return dcl.URL("projects/{{project}}/regions/{{location}}/sslCertificates", "https://www.googleapis.com/compute/beta/", userBasePath, params), nil
	}
