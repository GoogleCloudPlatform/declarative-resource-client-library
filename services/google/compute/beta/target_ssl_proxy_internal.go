...
func targetSslProxyGetURL(userBasePath string, r *TargetSslProxy) (string, error) {
	...
	return dcl.URL("projects/{{project}}/global/targetSslProxies/{{name}}", "https://www.googleapis.com/compute/beta/", userBasePath, params), nil
}
...
func targetSslProxyListURL(userBasePath, project string) (string, error) {
	...
	return dcl.URL("projects/{{project}}/global/targetSslProxies", "https://www.googleapis.com/compute/beta/", userBasePath, params), nil
...
func (c *Client) targetSslProxyDiffsForRawDesired(ctx context.Context, rawDesired *TargetSslProxy, opts ...dcl.ApplyOption) (initial, desired *TargetSslProxy, diffs []targetSslProxyDiff, err error) {
...
func diffTargetSslProxy(c *Client, desired, actual *TargetSslProxy, opts ...dcl.ApplyOption) ([]targetSslProxyDiff, error) {
	...
	var opTypes []string
	var deduped []targetSslProxyDiff
	for _, d := range diffs {
