...
func backendBucketGetURL(userBasePath string, r *BackendBucket) (string, error) {
	...
	return dcl.URL("projects/{{project}}/global/backendBuckets/{{name}}", "https://www.googleapis.com/compute/v1/", userBasePath, params), nil
}
...
func backendBucketListURL(userBasePath, project string) (string, error) {
	...
	return dcl.URL("projects/{{project}}/global/backendBuckets", "https://www.googleapis.com/compute/v1/", userBasePath, params), nil
...
func (r *BackendBucket) updateURL(userBasePath, updateName string) (string, error) {
	...
	if updateName == "update" {
		...
		return dcl.URL("projects/{{project}}/global/backendBuckets/{{name}}", "https://www.googleapis.com/compute/v1/", userBasePath, fields), nil
