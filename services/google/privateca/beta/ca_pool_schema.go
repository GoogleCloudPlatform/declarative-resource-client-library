											...
											"caOptions": &dcl.Property{
												...
												Properties: map[string]*dcl.Property{
													...
													"nonCa": &dcl.Property{
														Type:        "boolean",
														GoName:      "NonCa",
														Description: "Optional. When true, the \"CA\" X.509 extension will be set to false. If both `is_ca` and `non_ca` are unset, the extension will be omitted from the CA certificate.",
													},
