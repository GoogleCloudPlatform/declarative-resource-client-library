...
func flattenCertificateAuthorityCaCertificateDescriptionsX509DescriptionCAOptions(_ *Client, i any, res *CertificateAuthority) *CertificateAuthorityCaCertificateDescriptionsX509DescriptionCaOptions {
...
func expandCertificateAuthorityCaCertificateDescriptionsX509DescriptionCAOptions(c *Client, f *CertificateAuthorityCaCertificateDescriptionsX509DescriptionCaOptions, res *CertificateAuthority) (map[string]any, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}

	isCA := dcl.ValueOrEmptyBool(f.IsCa)
	nonCA := dcl.ValueOrEmptyBool(f.NonCa)
