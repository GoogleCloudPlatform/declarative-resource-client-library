...
func (r *ClusterClusterConfigGkeClusterConfig) validate() error {
...
func (r *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) validate() error {
	return nil
}
func (r *ClusterClusterConfigMetastoreConfig) validate() error {
...
func clusterGetURL(userBasePath string, r *Cluster) (string, error) {
	...
	return dcl.URL("projects/{{project}}/regions/{{location}}/clusters/{{name}}", "https://dataproc.googleapis.com/v1beta2/", userBasePath, params), nil
}
...
func clusterListURL(userBasePath, project, location string) (string, error) {
	...
	return dcl.URL("projects/{{project}}/regions/{{location}}/clusters", "https://dataproc.googleapis.com/v1beta2/", userBasePath, params), nil
...
func (r *Cluster) SetPolicyURL(userBasePath string) string {
	...
	return dcl.URL("projects/{{project}}/regions/{{location}}/clusters/{{name}}:setIamPolicy", "https://dataproc.googleapis.com/v1beta2/", userBasePath, fields)
}
...
func (r *Cluster) getPolicyURL(userBasePath string) string {
	...
	return dcl.URL("projects/{{project}}/regions/{{location}}/clusters/{{name}}:getIamPolicy", "https://dataproc.googleapis.com/v1beta2/", userBasePath, fields)
}
...
func (op *updateClusterUpdateClusterOperation) do(ctx context.Context, r *Cluster, c *Client) error {
	...
	err = o.Wait(ctx, c.Config, "https://dataproc.googleapis.com/v1beta2/", "GET")
...
func canonicalizeClusterDesiredState(rawDesired, rawInitial *Cluster, opts ...dcl.ApplyOption) (*Cluster, error) {
	...
	if dcl.StringCanonicalize(rawDesired.ClusterUuid, rawInitial.ClusterUuid) {
...
func canonicalizeNewClusterClusterConfig(c *Client, des, nw *ClusterClusterConfig) *ClusterClusterConfig {
	...
	nw.GkeClusterConfig = canonicalizeNewClusterClusterConfigGkeClusterConfig(c, des.GkeClusterConfig, nw.GkeClusterConfig)
	nw.MetastoreConfig = canonicalizeNewClusterClusterConfigMetastoreConfig(c, des.MetastoreConfig, nw.MetastoreConfig)
...
func canonicalizeClusterInstanceGroupConfigManagedGroupConfig(des, initial *ClusterInstanceGroupConfigManagedGroupConfig, opts ...dcl.ApplyOption) *ClusterInstanceGroupConfigManagedGroupConfig {
	...
	if dcl.StringCanonicalize(des.InstanceTemplateName, initial.InstanceTemplateName) || dcl.IsZeroValue(des.InstanceTemplateName) {
		des.InstanceTemplateName = initial.InstanceTemplateName
	}
	if dcl.StringCanonicalize(des.InstanceGroupManagerName, initial.InstanceGroupManagerName) || dcl.IsZeroValue(des.InstanceGroupManagerName) {
...
func canonicalizeClusterClusterConfigGkeClusterConfig(des, initial *ClusterClusterConfigGkeClusterConfig, opts ...dcl.ApplyOption) *ClusterClusterConfigGkeClusterConfig {
	if des == nil {
		return initial
	}
	if des.empty {
...
func canonicalizeNewClusterClusterConfigGkeClusterConfig(c *Client, des, nw *ClusterClusterConfigGkeClusterConfig) *ClusterClusterConfigGkeClusterConfig {
	...
	nw.NamespacedGkeDeploymentTarget = canonicalizeNewClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, des.NamespacedGkeDeploymentTarget, nw.NamespacedGkeDeploymentTarget)

	return nw
}

func canonicalizeNewClusterClusterConfigGkeClusterConfigSet(c *Client, des, nw []ClusterClusterConfigGkeClusterConfig) []ClusterClusterConfigGkeClusterConfig {
	if des == nil {
		return nw
	}
	var reorderedNew []ClusterClusterConfigGkeClusterConfig
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if !compareClusterClusterConfigGkeClusterConfig(c, &d, &n) {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewClusterClusterConfigGkeClusterConfigSlice(c *Client, des, nw []ClusterClusterConfigGkeClusterConfig) []ClusterClusterConfigGkeClusterConfig {
	if des == nil {
		return nw
	}
	...
	var items []ClusterClusterConfigGkeClusterConfig
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewClusterClusterConfigGkeClusterConfig(c, &d, &n))
	}

	return items
}

func canonicalizeClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(des, initial *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, opts ...dcl.ApplyOption) *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	if des == nil {
		return initial
	}
	if des.empty {
...
func canonicalizeNewClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSet(c *Client, des, nw []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	if des == nil {
		return nw
	}
	var reorderedNew []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if !compareClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, &d, &n) {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(c *Client, des, nw []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	if des == nil {
		return nw
	}
	...
	var items []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, &d, &n))
	}

	return items
}

func canonicalizeClusterClusterConfigMetastoreConfig(des, initial *ClusterClusterConfigMetastoreConfig, opts ...dcl.ApplyOption) *ClusterClusterConfigMetastoreConfig {
	if des == nil {
		return initial
	}
	if des.empty {
...
func canonicalizeNewClusterClusterConfigMetastoreConfigSet(c *Client, des, nw []ClusterClusterConfigMetastoreConfig) []ClusterClusterConfigMetastoreConfig {
	if des == nil {
		return nw
	}
	var reorderedNew []ClusterClusterConfigMetastoreConfig
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if !compareClusterClusterConfigMetastoreConfig(c, &d, &n) {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewClusterClusterConfigMetastoreConfigSlice(c *Client, des, nw []ClusterClusterConfigMetastoreConfig) []ClusterClusterConfigMetastoreConfig {
	if des == nil {
		return nw
	}
	...
	var items []ClusterClusterConfigMetastoreConfig
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewClusterClusterConfigMetastoreConfig(c, &d, &n))
	}
...
func canonicalizeClusterStatus(des, initial *ClusterStatus, opts ...dcl.ApplyOption) *ClusterStatus {
	...
	if dcl.StringCanonicalize(des.Detail, initial.Detail) || dcl.IsZeroValue(des.Detail) {
...
func compareClusterClusterConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.GkeClusterConfig, actual.GkeClusterConfig, dcl.Info{ObjectFunction: compareClusterClusterConfigGkeClusterConfigNewStyle}, fn.AddNest("GkeClusterConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.MetastoreConfig, actual.MetastoreConfig, dcl.Info{ObjectFunction: compareClusterClusterConfigMetastoreConfigNewStyle}, fn.AddNest("MetastoreConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterClusterConfigMap(c *Client, desired, actual map[string]ClusterClusterConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		...
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigGceClusterConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigGceClusterConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigGceClusterConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigGceClusterConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigGceClusterConfigReservationAffinityMap(c *Client, desired, actual map[string]ClusterClusterConfigGceClusterConfigReservationAffinity) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigGceClusterConfigReservationAffinity, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigGceClusterConfigReservationAffinity, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigGceClusterConfigNodeGroupAffinityMap(c *Client, desired, actual map[string]ClusterClusterConfigGceClusterConfigNodeGroupAffinity) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigGceClusterConfigNodeGroupAffinity, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigGceClusterConfigNodeGroupAffinity, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterInstanceGroupConfigMap(c *Client, desired, actual map[string]ClusterInstanceGroupConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterInstanceGroupConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterInstanceGroupConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterInstanceGroupConfigDiskConfigMap(c *Client, desired, actual map[string]ClusterInstanceGroupConfigDiskConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterInstanceGroupConfigDiskConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterInstanceGroupConfigDiskConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterInstanceGroupConfigManagedGroupConfigMap(c *Client, desired, actual map[string]ClusterInstanceGroupConfigManagedGroupConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterInstanceGroupConfigManagedGroupConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterInstanceGroupConfigManagedGroupConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterInstanceGroupConfigAcceleratorsMap(c *Client, desired, actual map[string]ClusterInstanceGroupConfigAccelerators) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterInstanceGroupConfigAccelerators, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterInstanceGroupConfigAccelerators, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigSoftwareConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigSoftwareConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigSoftwareConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigSoftwareConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigInitializationActionsMap(c *Client, desired, actual map[string]ClusterClusterConfigInitializationActions) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigInitializationActions, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigInitializationActions, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigEncryptionConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigEncryptionConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigEncryptionConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigEncryptionConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigAutoscalingConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigAutoscalingConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigAutoscalingConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigAutoscalingConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigSecurityConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigSecurityConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigSecurityConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigSecurityConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigSecurityConfigKerberosConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigSecurityConfigKerberosConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigSecurityConfigKerberosConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigSecurityConfigKerberosConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigLifecycleConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigLifecycleConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigLifecycleConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigLifecycleConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigEndpointConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigEndpointConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigEndpointConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigEndpointConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigGkeClusterConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*ClusterClusterConfigGkeClusterConfig)
	if !ok {
		desiredNotPointer, ok := d.(ClusterClusterConfigGkeClusterConfig)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterClusterConfigGkeClusterConfig or *ClusterClusterConfigGkeClusterConfig", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*ClusterClusterConfigGkeClusterConfig)
	if !ok {
		actualNotPointer, ok := a.(ClusterClusterConfigGkeClusterConfig)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterClusterConfigGkeClusterConfig", a)
		}
		actual = &actualNotPointer
	}

	if ds, err := dcl.Diff(desired.NamespacedGkeDeploymentTarget, actual.NamespacedGkeDeploymentTarget, dcl.Info{ObjectFunction: compareClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetNewStyle}, fn.AddNest("NamespacedGkeDeploymentTarget")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterClusterConfigGkeClusterConfig(c *Client, desired, actual *ClusterClusterConfigGkeClusterConfig) bool {
	if desired == nil {
		return false
	}
	if actual == nil {
...
func compareClusterClusterConfigGkeClusterConfigSlice(c *Client, desired, actual []ClusterClusterConfigGkeClusterConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigGkeClusterConfig, lengths unequal.")
		return true
	}
	for i := 0; i < len(desired); i++ {
...
func compareClusterClusterConfigGkeClusterConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigGkeClusterConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigGkeClusterConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigGkeClusterConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
	if !ok {
		desiredNotPointer, ok := d.(ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget or *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
	if !ok {
		actualNotPointer, ok := a.(ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget", a)
		}
		actual = &actualNotPointer
	}

	if ds, err := dcl.Diff(desired.TargetGkeCluster, actual.TargetGkeCluster, dcl.Info{Type: "ReferenceType"}, fn.AddNest("TargetGkeCluster")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.ClusterNamespace, actual.ClusterNamespace, dcl.Info{}, fn.AddNest("ClusterNamespace")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c *Client, desired, actual *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) bool {
	if desired == nil {
		return false
	}
	if actual == nil {
...
func compareClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(c *Client, desired, actual []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, lengths unequal.")
		return true
	}
	for i := 0; i < len(desired); i++ {
...
func compareClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap(c *Client, desired, actual map[string]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterClusterConfigMetastoreConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*ClusterClusterConfigMetastoreConfig)
	if !ok {
		desiredNotPointer, ok := d.(ClusterClusterConfigMetastoreConfig)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterClusterConfigMetastoreConfig or *ClusterClusterConfigMetastoreConfig", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*ClusterClusterConfigMetastoreConfig)
	if !ok {
		actualNotPointer, ok := a.(ClusterClusterConfigMetastoreConfig)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a ClusterClusterConfigMetastoreConfig", a)
		}
		actual = &actualNotPointer
	}

	if ds, err := dcl.Diff(desired.DataprocMetastoreService, actual.DataprocMetastoreService, dcl.Info{Type: "ReferenceType"}, fn.AddNest("DataprocMetastoreService")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterClusterConfigMetastoreConfig(c *Client, desired, actual *ClusterClusterConfigMetastoreConfig) bool {
	if desired == nil {
		return false
	}
	if actual == nil {
...
func compareClusterClusterConfigMetastoreConfigSlice(c *Client, desired, actual []ClusterClusterConfigMetastoreConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigMetastoreConfig, lengths unequal.")
		return true
	}
	for i := 0; i < len(desired); i++ {
...
func compareClusterClusterConfigMetastoreConfigMap(c *Client, desired, actual map[string]ClusterClusterConfigMetastoreConfig) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterClusterConfigMetastoreConfig, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterClusterConfigMetastoreConfig, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterStatusMap(c *Client, desired, actual map[string]ClusterStatus) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterStatus, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterStatus, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterStatusHistoryMap(c *Client, desired, actual map[string]ClusterStatusHistory) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterStatusHistory, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterStatusHistory, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func compareClusterMetricsMap(c *Client, desired, actual map[string]ClusterMetrics) bool {
	if len(desired) != len(actual) {
		c.Config.Logger.Info("Diff in ClusterMetrics, lengths unequal.")
		return true
	}
	for k, desiredValue := range desired {
		actualValue, ok := actual[k]
		if !ok {
			c.Config.Logger.Infof("Diff in ClusterMetrics, key %s not found in ACTUAL.\n", k)
			return true
		}
...
func (r *Cluster) updateURL(userBasePath, updateName string) (string, error) {
	...
	if updateName == "UpdateCluster" {
		...
		return dcl.URL("projects/{{project}}/regions/{{location}}/clusters/{{name}}", "https://dataproc.googleapis.com/v1beta2/", userBasePath, fields), nil
...
func expandClusterClusterConfig(c *Client, f *ClusterClusterConfig) (map[string]interface{}, error) {
	...
	if v, err := expandClusterClusterConfigGkeClusterConfig(c, f.GkeClusterConfig); err != nil {
		return nil, fmt.Errorf("error expanding GkeClusterConfig into gkeClusterConfig: %w", err)
	} else if !dcl.IsEmptyValueIndirect(v) {
		m["gkeClusterConfig"] = v
	}
	if v, err := expandClusterClusterConfigMetastoreConfig(c, f.MetastoreConfig); err != nil {
...
func flattenClusterClusterConfig(c *Client, i interface{}) *ClusterClusterConfig {
	...
	r.GkeClusterConfig = flattenClusterClusterConfigGkeClusterConfig(c, m["gkeClusterConfig"])
	r.MetastoreConfig = flattenClusterClusterConfigMetastoreConfig(c, m["metastoreConfig"])
...
// expandClusterClusterConfigGkeClusterConfigMap expands the contents of ClusterClusterConfigGkeClusterConfig into a JSON
// request object.
func expandClusterClusterConfigGkeClusterConfigMap(c *Client, f map[string]ClusterClusterConfigGkeClusterConfig) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandClusterClusterConfigGkeClusterConfig(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandClusterClusterConfigGkeClusterConfigSlice expands the contents of ClusterClusterConfigGkeClusterConfig into a JSON
// request object.
func expandClusterClusterConfigGkeClusterConfigSlice(c *Client, f []ClusterClusterConfigGkeClusterConfig) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenClusterClusterConfigGkeClusterConfigMap flattens the contents of ClusterClusterConfigGkeClusterConfig from a JSON
// response object.
func flattenClusterClusterConfigGkeClusterConfigMap(c *Client, i interface{}) map[string]ClusterClusterConfigGkeClusterConfig {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]ClusterClusterConfigGkeClusterConfig{}
	}
	...
	items := make(map[string]ClusterClusterConfigGkeClusterConfig)
	for k, item := range a {
		items[k] = *flattenClusterClusterConfigGkeClusterConfig(c, item.(map[string]interface{}))
	}

	return items
}

// flattenClusterClusterConfigGkeClusterConfigSlice flattens the contents of ClusterClusterConfigGkeClusterConfig from a JSON
// response object.
func flattenClusterClusterConfigGkeClusterConfigSlice(c *Client, i interface{}) []ClusterClusterConfigGkeClusterConfig {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]ClusterClusterConfigGkeClusterConfig, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenClusterClusterConfigGkeClusterConfig(c, item.(map[string]interface{})))
	}
...
// flattenClusterClusterConfigGkeClusterConfig flattens an instance of ClusterClusterConfigGkeClusterConfig from a JSON
// response object.
func flattenClusterClusterConfigGkeClusterConfig(c *Client, i interface{}) *ClusterClusterConfigGkeClusterConfig {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &ClusterClusterConfigGkeClusterConfig{}
	r.NamespacedGkeDeploymentTarget = flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, m["namespacedGkeDeploymentTarget"])

	return r
}

// expandClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap expands the contents of ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget into a JSON
// request object.
func expandClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap(c *Client, f map[string]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice expands the contents of ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget into a JSON
// request object.
func expandClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(c *Client, f []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap flattens the contents of ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget from a JSON
// response object.
func flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetMap(c *Client, i interface{}) map[string]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}
	}
	...
	items := make(map[string]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget)
	for k, item := range a {
		items[k] = *flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, item.(map[string]interface{}))
	}

	return items
}

// flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice flattens the contents of ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget from a JSON
// response object.
func flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(c *Client, i interface{}) []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c, item.(map[string]interface{})))
	}
...
// flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget flattens an instance of ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget from a JSON
// response object.
func flattenClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c *Client, i interface{}) *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}
...
// expandClusterClusterConfigMetastoreConfigMap expands the contents of ClusterClusterConfigMetastoreConfig into a JSON
// request object.
func expandClusterClusterConfigMetastoreConfigMap(c *Client, f map[string]ClusterClusterConfigMetastoreConfig) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandClusterClusterConfigMetastoreConfig(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandClusterClusterConfigMetastoreConfigSlice expands the contents of ClusterClusterConfigMetastoreConfig into a JSON
// request object.
func expandClusterClusterConfigMetastoreConfigSlice(c *Client, f []ClusterClusterConfigMetastoreConfig) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenClusterClusterConfigMetastoreConfigMap flattens the contents of ClusterClusterConfigMetastoreConfig from a JSON
// response object.
func flattenClusterClusterConfigMetastoreConfigMap(c *Client, i interface{}) map[string]ClusterClusterConfigMetastoreConfig {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]ClusterClusterConfigMetastoreConfig{}
	}
	...
	items := make(map[string]ClusterClusterConfigMetastoreConfig)
	for k, item := range a {
		items[k] = *flattenClusterClusterConfigMetastoreConfig(c, item.(map[string]interface{}))
	}

	return items
}

// flattenClusterClusterConfigMetastoreConfigSlice flattens the contents of ClusterClusterConfigMetastoreConfig from a JSON
// response object.
func flattenClusterClusterConfigMetastoreConfigSlice(c *Client, i interface{}) []ClusterClusterConfigMetastoreConfig {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]ClusterClusterConfigMetastoreConfig, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenClusterClusterConfigMetastoreConfig(c, item.(map[string]interface{})))
	}
...
// flattenClusterClusterConfigMetastoreConfig flattens an instance of ClusterClusterConfigMetastoreConfig from a JSON
// response object.
func flattenClusterClusterConfigMetastoreConfig(c *Client, i interface{}) *ClusterClusterConfigMetastoreConfig {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &ClusterClusterConfigMetastoreConfig{}
