...
func canonicalizeClusterClusterConfigGkeClusterConfigSlice(des, initial []ClusterClusterConfigGkeClusterConfig, opts ...dcl.ApplyOption) []ClusterClusterConfigGkeClusterConfig {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]ClusterClusterConfigGkeClusterConfig, 0, len(des))
		for _, d := range des {
			cd := canonicalizeClusterClusterConfigGkeClusterConfig(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]ClusterClusterConfigGkeClusterConfig, 0, len(des))
	for i, d := range des {
		cd := canonicalizeClusterClusterConfigGkeClusterConfig(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewClusterClusterConfigGkeClusterConfig(c *Client, des, nw *ClusterClusterConfigGkeClusterConfig) *ClusterClusterConfigGkeClusterConfig {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for ClusterClusterConfigGkeClusterConfig while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}
...
func canonicalizeClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetSlice(des, initial []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, opts ...dcl.ApplyOption) []ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, 0, len(des))
		for _, d := range des {
			cd := canonicalizeClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, 0, len(des))
	for i, d := range des {
		cd := canonicalizeClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget(c *Client, des, nw *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}
...
func canonicalizeClusterClusterConfigMetastoreConfigSlice(des, initial []ClusterClusterConfigMetastoreConfig, opts ...dcl.ApplyOption) []ClusterClusterConfigMetastoreConfig {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]ClusterClusterConfigMetastoreConfig, 0, len(des))
		for _, d := range des {
			cd := canonicalizeClusterClusterConfigMetastoreConfig(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]ClusterClusterConfigMetastoreConfig, 0, len(des))
	for i, d := range des {
		cd := canonicalizeClusterClusterConfigMetastoreConfig(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewClusterClusterConfigMetastoreConfig(c *Client, des, nw *ClusterClusterConfigMetastoreConfig) *ClusterClusterConfigMetastoreConfig {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for ClusterClusterConfigMetastoreConfig while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}
...
func compareClusterClusterConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.GkeClusterConfig, actual.GkeClusterConfig, dcl.Info{ObjectFunction: compareClusterClusterConfigGkeClusterConfigNewStyle, EmptyObject: EmptyClusterClusterConfigGkeClusterConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("GkeClusterConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.MetastoreConfig, actual.MetastoreConfig, dcl.Info{ObjectFunction: compareClusterClusterConfigMetastoreConfigNewStyle, EmptyObject: EmptyClusterClusterConfigMetastoreConfig, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("MetastoreConfig")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareClusterClusterConfigGkeClusterConfigNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.NamespacedGkeDeploymentTarget, actual.NamespacedGkeDeploymentTarget, dcl.Info{ObjectFunction: compareClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetNewStyle, EmptyObject: EmptyClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget, OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("NamespacedGkeDeploymentTarget")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func extractClusterClusterConfigFields(r *Cluster, o *ClusterClusterConfig) error {
	...
	if vGkeClusterConfig == nil {
		// note: explicitly not the empty object.
		vGkeClusterConfig = &ClusterClusterConfigGkeClusterConfig{}
	}
	if err := extractClusterClusterConfigGkeClusterConfigFields(r, vGkeClusterConfig); err != nil {
		return err
	}
	...
	if vMetastoreConfig == nil {
		// note: explicitly not the empty object.
		vMetastoreConfig = &ClusterClusterConfigMetastoreConfig{}
	}
	if err := extractClusterClusterConfigMetastoreConfigFields(r, vMetastoreConfig); err != nil {
		return err
	}
...
func extractClusterClusterConfigGkeClusterConfigFields(r *Cluster, o *ClusterClusterConfigGkeClusterConfig) error {
	vNamespacedGkeDeploymentTarget := o.NamespacedGkeDeploymentTarget
	if vNamespacedGkeDeploymentTarget == nil {
		// note: explicitly not the empty object.
		vNamespacedGkeDeploymentTarget = &ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}
	}
	if err := extractClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetFields(r, vNamespacedGkeDeploymentTarget); err != nil {
		return err
	}
...
func extractClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetFields(r *Cluster, o *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) error {
	return nil
}
func extractClusterClusterConfigMetastoreConfigFields(r *Cluster, o *ClusterClusterConfigMetastoreConfig) error {
	return nil
}
...
func postReadExtractClusterClusterConfigGkeClusterConfigFields(r *Cluster, o *ClusterClusterConfigGkeClusterConfig) error {
	vNamespacedGkeDeploymentTarget := o.NamespacedGkeDeploymentTarget
	if vNamespacedGkeDeploymentTarget == nil {
		// note: explicitly not the empty object.
		vNamespacedGkeDeploymentTarget = &ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget{}
...
func postReadExtractClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTargetFields(r *Cluster, o *ClusterClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget) error {
	return nil
}
func postReadExtractClusterClusterConfigMetastoreConfigFields(r *Cluster, o *ClusterClusterConfigMetastoreConfig) error {
	return nil
}
