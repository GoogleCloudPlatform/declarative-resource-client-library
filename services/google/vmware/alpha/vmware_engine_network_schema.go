					...
					SchemaProperty: dcl.Property{
						...
						Properties: map[string]*dcl.Property{
							...
							"state": &dcl.Property{
								...
								ReadOnly:    true,
								Description: "Output only. State of the VMware Engine network. Possible values: STATE_UNSPECIFIED, ACTIVE, CREATING, UPDATING, FAILED, DELETED, PURGING",
								Immutable:   true,
								Enum: []string{
									"STATE_UNSPECIFIED",
									"ACTIVE",
							...
							"type": &dcl.Property{
								...
								Description: "Required. VMware Engine network type. Possible values: PATH, OTHER, PARAMETER",
								Immutable:   true,
								Enum: []string{
									"PATH",
									"OTHER",
								...
								Items: &dcl.Property{
									...
									Properties: map[string]*dcl.Property{
										...
										"type": &dcl.Property{
											...
											ReadOnly:    true,
											Description: "Output only. Type of VPC network (INTRANET, INTERNET, or GOOGLE_CLOUD) Possible values: PATH, OTHER, PARAMETER",
											Immutable:   true,
											Enum: []string{
												"PATH",
												"OTHER",
