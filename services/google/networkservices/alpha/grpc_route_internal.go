...
func (r *GrpcRouteRulesActionRequestHeaderModifier) validate() error {
	return nil
}
func (r *GrpcRouteRulesActionResponseHeaderModifier) validate() error {
	return nil
}
func (r *GrpcRouteRulesActionUrlRewrite) validate() error {
	return nil
}
func (r *GrpcRouteRulesActionRetryPolicy) validate() error {
	return nil
}
func (r *GrpcRouteRulesActionRequestMirrorPolicy) validate() error {
...
func canonicalizeGrpcRouteRulesAction(des, initial *GrpcRouteRulesAction, opts ...dcl.ApplyOption) *GrpcRouteRulesAction {
	...
	cDes.RequestHeaderModifier = canonicalizeGrpcRouteRulesActionRequestHeaderModifier(des.RequestHeaderModifier, initial.RequestHeaderModifier, opts...)
	cDes.ResponseHeaderModifier = canonicalizeGrpcRouteRulesActionResponseHeaderModifier(des.ResponseHeaderModifier, initial.ResponseHeaderModifier, opts...)
	cDes.UrlRewrite = canonicalizeGrpcRouteRulesActionUrlRewrite(des.UrlRewrite, initial.UrlRewrite, opts...)
	...
	cDes.RequestMirrorPolicy = canonicalizeGrpcRouteRulesActionRequestMirrorPolicy(des.RequestMirrorPolicy, initial.RequestMirrorPolicy, opts...)
...
func canonicalizeNewGrpcRouteRulesAction(c *Client, des, nw *GrpcRouteRulesAction) *GrpcRouteRulesAction {
	...
	nw.RequestHeaderModifier = canonicalizeNewGrpcRouteRulesActionRequestHeaderModifier(c, des.RequestHeaderModifier, nw.RequestHeaderModifier)
	nw.ResponseHeaderModifier = canonicalizeNewGrpcRouteRulesActionResponseHeaderModifier(c, des.ResponseHeaderModifier, nw.ResponseHeaderModifier)
	nw.UrlRewrite = canonicalizeNewGrpcRouteRulesActionUrlRewrite(c, des.UrlRewrite, nw.UrlRewrite)
	...
	nw.RequestMirrorPolicy = canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicy(c, des.RequestMirrorPolicy, nw.RequestMirrorPolicy)
...
func canonicalizeGrpcRouteRulesActionRequestHeaderModifier(des, initial *GrpcRouteRulesActionRequestHeaderModifier, opts ...dcl.ApplyOption) *GrpcRouteRulesActionRequestHeaderModifier {
	if des == nil {
		return initial
	}
	if des.empty {
...
func canonicalizeGrpcRouteRulesActionRequestHeaderModifierSlice(des, initial []GrpcRouteRulesActionRequestHeaderModifier, opts ...dcl.ApplyOption) []GrpcRouteRulesActionRequestHeaderModifier {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]GrpcRouteRulesActionRequestHeaderModifier, 0, len(des))
		for _, d := range des {
			cd := canonicalizeGrpcRouteRulesActionRequestHeaderModifier(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]GrpcRouteRulesActionRequestHeaderModifier, 0, len(des))
	for i, d := range des {
		cd := canonicalizeGrpcRouteRulesActionRequestHeaderModifier(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewGrpcRouteRulesActionRequestHeaderModifier(c *Client, des, nw *GrpcRouteRulesActionRequestHeaderModifier) *GrpcRouteRulesActionRequestHeaderModifier {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for GrpcRouteRulesActionRequestHeaderModifier while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}
...
func canonicalizeNewGrpcRouteRulesActionRequestHeaderModifierSet(c *Client, des, nw []GrpcRouteRulesActionRequestHeaderModifier) []GrpcRouteRulesActionRequestHeaderModifier {
	if des == nil {
		return nw
	}
	var reorderedNew []GrpcRouteRulesActionRequestHeaderModifier
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if diffs, _ := compareGrpcRouteRulesActionRequestHeaderModifierNewStyle(&d, &n, dcl.FieldName{}); len(diffs) == 0 {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewGrpcRouteRulesActionRequestHeaderModifierSlice(c *Client, des, nw []GrpcRouteRulesActionRequestHeaderModifier) []GrpcRouteRulesActionRequestHeaderModifier {
	if des == nil {
		return nw
	}
	...
	var items []GrpcRouteRulesActionRequestHeaderModifier
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewGrpcRouteRulesActionRequestHeaderModifier(c, &d, &n))
	}

	return items
}

func canonicalizeGrpcRouteRulesActionResponseHeaderModifier(des, initial *GrpcRouteRulesActionResponseHeaderModifier, opts ...dcl.ApplyOption) *GrpcRouteRulesActionResponseHeaderModifier {
	if des == nil {
		return initial
	}
	if des.empty {
...
func canonicalizeGrpcRouteRulesActionResponseHeaderModifierSlice(des, initial []GrpcRouteRulesActionResponseHeaderModifier, opts ...dcl.ApplyOption) []GrpcRouteRulesActionResponseHeaderModifier {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]GrpcRouteRulesActionResponseHeaderModifier, 0, len(des))
		for _, d := range des {
			cd := canonicalizeGrpcRouteRulesActionResponseHeaderModifier(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]GrpcRouteRulesActionResponseHeaderModifier, 0, len(des))
	for i, d := range des {
		cd := canonicalizeGrpcRouteRulesActionResponseHeaderModifier(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewGrpcRouteRulesActionResponseHeaderModifier(c *Client, des, nw *GrpcRouteRulesActionResponseHeaderModifier) *GrpcRouteRulesActionResponseHeaderModifier {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for GrpcRouteRulesActionResponseHeaderModifier while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}
...
func canonicalizeNewGrpcRouteRulesActionResponseHeaderModifierSet(c *Client, des, nw []GrpcRouteRulesActionResponseHeaderModifier) []GrpcRouteRulesActionResponseHeaderModifier {
	if des == nil {
		return nw
	}
	var reorderedNew []GrpcRouteRulesActionResponseHeaderModifier
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if diffs, _ := compareGrpcRouteRulesActionResponseHeaderModifierNewStyle(&d, &n, dcl.FieldName{}); len(diffs) == 0 {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewGrpcRouteRulesActionResponseHeaderModifierSlice(c *Client, des, nw []GrpcRouteRulesActionResponseHeaderModifier) []GrpcRouteRulesActionResponseHeaderModifier {
	if des == nil {
		return nw
	}
	...
	var items []GrpcRouteRulesActionResponseHeaderModifier
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewGrpcRouteRulesActionResponseHeaderModifier(c, &d, &n))
	}

	return items
}

func canonicalizeGrpcRouteRulesActionUrlRewrite(des, initial *GrpcRouteRulesActionUrlRewrite, opts ...dcl.ApplyOption) *GrpcRouteRulesActionUrlRewrite {
	if des == nil {
		return initial
	}
	if des.empty {
	...
	cDes := &GrpcRouteRulesActionUrlRewrite{}
...
func canonicalizeGrpcRouteRulesActionUrlRewriteSlice(des, initial []GrpcRouteRulesActionUrlRewrite, opts ...dcl.ApplyOption) []GrpcRouteRulesActionUrlRewrite {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]GrpcRouteRulesActionUrlRewrite, 0, len(des))
		for _, d := range des {
			cd := canonicalizeGrpcRouteRulesActionUrlRewrite(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]GrpcRouteRulesActionUrlRewrite, 0, len(des))
	for i, d := range des {
		cd := canonicalizeGrpcRouteRulesActionUrlRewrite(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewGrpcRouteRulesActionUrlRewrite(c *Client, des, nw *GrpcRouteRulesActionUrlRewrite) *GrpcRouteRulesActionUrlRewrite {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for GrpcRouteRulesActionUrlRewrite while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}
...
func canonicalizeNewGrpcRouteRulesActionUrlRewriteSet(c *Client, des, nw []GrpcRouteRulesActionUrlRewrite) []GrpcRouteRulesActionUrlRewrite {
	if des == nil {
		return nw
	}
	var reorderedNew []GrpcRouteRulesActionUrlRewrite
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if diffs, _ := compareGrpcRouteRulesActionUrlRewriteNewStyle(&d, &n, dcl.FieldName{}); len(diffs) == 0 {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewGrpcRouteRulesActionUrlRewriteSlice(c *Client, des, nw []GrpcRouteRulesActionUrlRewrite) []GrpcRouteRulesActionUrlRewrite {
	if des == nil {
		return nw
	}
	...
	var items []GrpcRouteRulesActionUrlRewrite
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewGrpcRouteRulesActionUrlRewrite(c, &d, &n))
	}
...
func canonicalizeGrpcRouteRulesActionRequestMirrorPolicy(des, initial *GrpcRouteRulesActionRequestMirrorPolicy, opts ...dcl.ApplyOption) *GrpcRouteRulesActionRequestMirrorPolicy {
	if des == nil {
		return initial
	}
	if des.empty {
	...
	cDes := &GrpcRouteRulesActionRequestMirrorPolicy{}

	cDes.Destination = canonicalizeGrpcRouteRulesActionRequestMirrorPolicyDestination(des.Destination, initial.Destination, opts...)

	return cDes
}

func canonicalizeGrpcRouteRulesActionRequestMirrorPolicySlice(des, initial []GrpcRouteRulesActionRequestMirrorPolicy, opts ...dcl.ApplyOption) []GrpcRouteRulesActionRequestMirrorPolicy {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]GrpcRouteRulesActionRequestMirrorPolicy, 0, len(des))
		for _, d := range des {
			cd := canonicalizeGrpcRouteRulesActionRequestMirrorPolicy(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]GrpcRouteRulesActionRequestMirrorPolicy, 0, len(des))
	for i, d := range des {
		cd := canonicalizeGrpcRouteRulesActionRequestMirrorPolicy(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicy(c *Client, des, nw *GrpcRouteRulesActionRequestMirrorPolicy) *GrpcRouteRulesActionRequestMirrorPolicy {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for GrpcRouteRulesActionRequestMirrorPolicy while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}

	nw.Destination = canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicyDestination(c, des.Destination, nw.Destination)

	return nw
}

func canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicySet(c *Client, des, nw []GrpcRouteRulesActionRequestMirrorPolicy) []GrpcRouteRulesActionRequestMirrorPolicy {
	if des == nil {
		return nw
	}
	var reorderedNew []GrpcRouteRulesActionRequestMirrorPolicy
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if diffs, _ := compareGrpcRouteRulesActionRequestMirrorPolicyNewStyle(&d, &n, dcl.FieldName{}); len(diffs) == 0 {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicySlice(c *Client, des, nw []GrpcRouteRulesActionRequestMirrorPolicy) []GrpcRouteRulesActionRequestMirrorPolicy {
	if des == nil {
		return nw
	}
	...
	var items []GrpcRouteRulesActionRequestMirrorPolicy
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicy(c, &d, &n))
	}

	return items
}

func canonicalizeGrpcRouteRulesActionRequestMirrorPolicyDestination(des, initial *GrpcRouteRulesActionRequestMirrorPolicyDestination, opts ...dcl.ApplyOption) *GrpcRouteRulesActionRequestMirrorPolicyDestination {
	if des == nil {
		return initial
	}
	if des.empty {
...
func canonicalizeGrpcRouteRulesActionRequestMirrorPolicyDestinationSlice(des, initial []GrpcRouteRulesActionRequestMirrorPolicyDestination, opts ...dcl.ApplyOption) []GrpcRouteRulesActionRequestMirrorPolicyDestination {
	if des == nil {
		return initial
	}
	...
	if len(des) != len(initial) {
		...
		items := make([]GrpcRouteRulesActionRequestMirrorPolicyDestination, 0, len(des))
		for _, d := range des {
			cd := canonicalizeGrpcRouteRulesActionRequestMirrorPolicyDestination(&d, nil, opts...)
			if cd != nil {
				items = append(items, *cd)
			}
		}
	...
	items := make([]GrpcRouteRulesActionRequestMirrorPolicyDestination, 0, len(des))
	for i, d := range des {
		cd := canonicalizeGrpcRouteRulesActionRequestMirrorPolicyDestination(&d, &initial[i], opts...)
		if cd != nil {
			items = append(items, *cd)
		}
	}
...
func canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicyDestination(c *Client, des, nw *GrpcRouteRulesActionRequestMirrorPolicyDestination) *GrpcRouteRulesActionRequestMirrorPolicyDestination {
	...
	if nw == nil {
		if dcl.IsNotReturnedByServer(des) {
			c.Config.Logger.Info("Found explicitly empty value for GrpcRouteRulesActionRequestMirrorPolicyDestination while comparing non-nil desired to nil actual.  Returning desired object.")
			return des
		}
		return nil
	}
...
func canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicyDestinationSet(c *Client, des, nw []GrpcRouteRulesActionRequestMirrorPolicyDestination) []GrpcRouteRulesActionRequestMirrorPolicyDestination {
	if des == nil {
		return nw
	}
	var reorderedNew []GrpcRouteRulesActionRequestMirrorPolicyDestination
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if diffs, _ := compareGrpcRouteRulesActionRequestMirrorPolicyDestinationNewStyle(&d, &n, dcl.FieldName{}); len(diffs) == 0 {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicyDestinationSlice(c *Client, des, nw []GrpcRouteRulesActionRequestMirrorPolicyDestination) []GrpcRouteRulesActionRequestMirrorPolicyDestination {
	if des == nil {
		return nw
	}
	...
	var items []GrpcRouteRulesActionRequestMirrorPolicyDestination
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewGrpcRouteRulesActionRequestMirrorPolicyDestination(c, &d, &n))
	}
...
func compareGrpcRouteRulesActionNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.RequestHeaderModifier, actual.RequestHeaderModifier, dcl.Info{ObjectFunction: compareGrpcRouteRulesActionRequestHeaderModifierNewStyle, EmptyObject: EmptyGrpcRouteRulesActionRequestHeaderModifier, OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("RequestHeaderModifier")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.ResponseHeaderModifier, actual.ResponseHeaderModifier, dcl.Info{ObjectFunction: compareGrpcRouteRulesActionResponseHeaderModifierNewStyle, EmptyObject: EmptyGrpcRouteRulesActionResponseHeaderModifier, OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("ResponseHeaderModifier")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.UrlRewrite, actual.UrlRewrite, dcl.Info{ObjectFunction: compareGrpcRouteRulesActionUrlRewriteNewStyle, EmptyObject: EmptyGrpcRouteRulesActionUrlRewrite, OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("UrlRewrite")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.RequestMirrorPolicy, actual.RequestMirrorPolicy, dcl.Info{ObjectFunction: compareGrpcRouteRulesActionRequestMirrorPolicyNewStyle, EmptyObject: EmptyGrpcRouteRulesActionRequestMirrorPolicy, OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("RequestMirrorPolicy")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareGrpcRouteRulesActionRequestHeaderModifierNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*GrpcRouteRulesActionRequestHeaderModifier)
	if !ok {
		desiredNotPointer, ok := d.(GrpcRouteRulesActionRequestHeaderModifier)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionRequestHeaderModifier or *GrpcRouteRulesActionRequestHeaderModifier", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*GrpcRouteRulesActionRequestHeaderModifier)
	if !ok {
		actualNotPointer, ok := a.(GrpcRouteRulesActionRequestHeaderModifier)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionRequestHeaderModifier", a)
		}
		actual = &actualNotPointer
	}

	if ds, err := dcl.Diff(desired.Set, actual.Set, dcl.Info{OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("Set")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.Add, actual.Add, dcl.Info{OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("Add")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.Remove, actual.Remove, dcl.Info{OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("Remove")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareGrpcRouteRulesActionResponseHeaderModifierNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*GrpcRouteRulesActionResponseHeaderModifier)
	if !ok {
		desiredNotPointer, ok := d.(GrpcRouteRulesActionResponseHeaderModifier)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionResponseHeaderModifier or *GrpcRouteRulesActionResponseHeaderModifier", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*GrpcRouteRulesActionResponseHeaderModifier)
	if !ok {
		actualNotPointer, ok := a.(GrpcRouteRulesActionResponseHeaderModifier)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionResponseHeaderModifier", a)
		}
		actual = &actualNotPointer
	}
...
func compareGrpcRouteRulesActionUrlRewriteNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*GrpcRouteRulesActionUrlRewrite)
	if !ok {
		desiredNotPointer, ok := d.(GrpcRouteRulesActionUrlRewrite)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionUrlRewrite or *GrpcRouteRulesActionUrlRewrite", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*GrpcRouteRulesActionUrlRewrite)
	if !ok {
		actualNotPointer, ok := a.(GrpcRouteRulesActionUrlRewrite)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionUrlRewrite", a)
		}
		actual = &actualNotPointer
	}

	if ds, err := dcl.Diff(desired.PathPrefixRewrite, actual.PathPrefixRewrite, dcl.Info{OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("PathPrefixRewrite")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
	...
	if ds, err := dcl.Diff(desired.HostRewrite, actual.HostRewrite, dcl.Info{OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("HostRewrite")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareGrpcRouteRulesActionRetryPolicyNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	...
	if ds, err := dcl.Diff(desired.PerTryTimeout, actual.PerTryTimeout, dcl.Info{OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("PerTryTimeout")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareGrpcRouteRulesActionRequestMirrorPolicyNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*GrpcRouteRulesActionRequestMirrorPolicy)
	if !ok {
		desiredNotPointer, ok := d.(GrpcRouteRulesActionRequestMirrorPolicy)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionRequestMirrorPolicy or *GrpcRouteRulesActionRequestMirrorPolicy", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*GrpcRouteRulesActionRequestMirrorPolicy)
	if !ok {
		actualNotPointer, ok := a.(GrpcRouteRulesActionRequestMirrorPolicy)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionRequestMirrorPolicy", a)
		}
		actual = &actualNotPointer
	}

	if ds, err := dcl.Diff(desired.Destination, actual.Destination, dcl.Info{ObjectFunction: compareGrpcRouteRulesActionRequestMirrorPolicyDestinationNewStyle, EmptyObject: EmptyGrpcRouteRulesActionRequestMirrorPolicyDestination, OperationSelector: dcl.TriggersOperation("updateGrpcRouteUpdateGrpcRouteOperation")}, fn.AddNest("Destination")); len(ds) != 0 || err != nil {
		if err != nil {
			return nil, err
		}
		diffs = append(diffs, ds...)
...
func compareGrpcRouteRulesActionRequestMirrorPolicyDestinationNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*GrpcRouteRulesActionRequestMirrorPolicyDestination)
	if !ok {
		desiredNotPointer, ok := d.(GrpcRouteRulesActionRequestMirrorPolicyDestination)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionRequestMirrorPolicyDestination or *GrpcRouteRulesActionRequestMirrorPolicyDestination", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*GrpcRouteRulesActionRequestMirrorPolicyDestination)
	if !ok {
		actualNotPointer, ok := a.(GrpcRouteRulesActionRequestMirrorPolicyDestination)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a GrpcRouteRulesActionRequestMirrorPolicyDestination", a)
		}
		actual = &actualNotPointer
	}
...
func expandGrpcRouteRulesAction(c *Client, f *GrpcRouteRulesAction) (map[string]interface{}, error) {
	...
	if v, err := expandGrpcRouteRulesActionRequestHeaderModifier(c, f.RequestHeaderModifier); err != nil {
		return nil, fmt.Errorf("error expanding RequestHeaderModifier into requestHeaderModifier: %w", err)
	} else if !dcl.IsEmptyValueIndirect(v) {
		m["requestHeaderModifier"] = v
	}
	if v, err := expandGrpcRouteRulesActionResponseHeaderModifier(c, f.ResponseHeaderModifier); err != nil {
		return nil, fmt.Errorf("error expanding ResponseHeaderModifier into responseHeaderModifier: %w", err)
	} else if !dcl.IsEmptyValueIndirect(v) {
		m["responseHeaderModifier"] = v
	}
	if v, err := expandGrpcRouteRulesActionUrlRewrite(c, f.UrlRewrite); err != nil {
	...
	if v, err := expandGrpcRouteRulesActionRequestMirrorPolicy(c, f.RequestMirrorPolicy); err != nil {
...
func flattenGrpcRouteRulesAction(c *Client, i interface{}) *GrpcRouteRulesAction {
	...
	r.RequestHeaderModifier = flattenGrpcRouteRulesActionRequestHeaderModifier(c, m["requestHeaderModifier"])
	r.ResponseHeaderModifier = flattenGrpcRouteRulesActionResponseHeaderModifier(c, m["responseHeaderModifier"])
	r.UrlRewrite = flattenGrpcRouteRulesActionUrlRewrite(c, m["urlRewrite"])
	r.Timeout = dcl.FlattenString(m["timeout"])
	r.RetryPolicy = flattenGrpcRouteRulesActionRetryPolicy(c, m["retryPolicy"])
	r.RequestMirrorPolicy = flattenGrpcRouteRulesActionRequestMirrorPolicy(c, m["requestMirrorPolicy"])
...
// expandGrpcRouteRulesActionRequestHeaderModifierMap expands the contents of GrpcRouteRulesActionRequestHeaderModifier into a JSON
// request object.
func expandGrpcRouteRulesActionRequestHeaderModifierMap(c *Client, f map[string]GrpcRouteRulesActionRequestHeaderModifier) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandGrpcRouteRulesActionRequestHeaderModifier(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandGrpcRouteRulesActionRequestHeaderModifierSlice expands the contents of GrpcRouteRulesActionRequestHeaderModifier into a JSON
// request object.
func expandGrpcRouteRulesActionRequestHeaderModifierSlice(c *Client, f []GrpcRouteRulesActionRequestHeaderModifier) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionRequestHeaderModifierMap flattens the contents of GrpcRouteRulesActionRequestHeaderModifier from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestHeaderModifierMap(c *Client, i interface{}) map[string]GrpcRouteRulesActionRequestHeaderModifier {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]GrpcRouteRulesActionRequestHeaderModifier{}
	}
	...
	items := make(map[string]GrpcRouteRulesActionRequestHeaderModifier)
	for k, item := range a {
		items[k] = *flattenGrpcRouteRulesActionRequestHeaderModifier(c, item.(map[string]interface{}))
	}

	return items
}

// flattenGrpcRouteRulesActionRequestHeaderModifierSlice flattens the contents of GrpcRouteRulesActionRequestHeaderModifier from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestHeaderModifierSlice(c *Client, i interface{}) []GrpcRouteRulesActionRequestHeaderModifier {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]GrpcRouteRulesActionRequestHeaderModifier, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenGrpcRouteRulesActionRequestHeaderModifier(c, item.(map[string]interface{})))
	}

	return items
}

// expandGrpcRouteRulesActionRequestHeaderModifier expands an instance of GrpcRouteRulesActionRequestHeaderModifier into a JSON
// request object.
func expandGrpcRouteRulesActionRequestHeaderModifier(c *Client, f *GrpcRouteRulesActionRequestHeaderModifier) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionRequestHeaderModifier flattens an instance of GrpcRouteRulesActionRequestHeaderModifier from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestHeaderModifier(c *Client, i interface{}) *GrpcRouteRulesActionRequestHeaderModifier {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &GrpcRouteRulesActionRequestHeaderModifier{}

	if dcl.IsEmptyValueIndirect(i) {
		return EmptyGrpcRouteRulesActionRequestHeaderModifier
	}
...
// expandGrpcRouteRulesActionResponseHeaderModifierMap expands the contents of GrpcRouteRulesActionResponseHeaderModifier into a JSON
// request object.
func expandGrpcRouteRulesActionResponseHeaderModifierMap(c *Client, f map[string]GrpcRouteRulesActionResponseHeaderModifier) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandGrpcRouteRulesActionResponseHeaderModifier(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandGrpcRouteRulesActionResponseHeaderModifierSlice expands the contents of GrpcRouteRulesActionResponseHeaderModifier into a JSON
// request object.
func expandGrpcRouteRulesActionResponseHeaderModifierSlice(c *Client, f []GrpcRouteRulesActionResponseHeaderModifier) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionResponseHeaderModifierMap flattens the contents of GrpcRouteRulesActionResponseHeaderModifier from a JSON
// response object.
func flattenGrpcRouteRulesActionResponseHeaderModifierMap(c *Client, i interface{}) map[string]GrpcRouteRulesActionResponseHeaderModifier {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]GrpcRouteRulesActionResponseHeaderModifier{}
	}
	...
	items := make(map[string]GrpcRouteRulesActionResponseHeaderModifier)
	for k, item := range a {
		items[k] = *flattenGrpcRouteRulesActionResponseHeaderModifier(c, item.(map[string]interface{}))
	}

	return items
}

// flattenGrpcRouteRulesActionResponseHeaderModifierSlice flattens the contents of GrpcRouteRulesActionResponseHeaderModifier from a JSON
// response object.
func flattenGrpcRouteRulesActionResponseHeaderModifierSlice(c *Client, i interface{}) []GrpcRouteRulesActionResponseHeaderModifier {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]GrpcRouteRulesActionResponseHeaderModifier, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenGrpcRouteRulesActionResponseHeaderModifier(c, item.(map[string]interface{})))
	}

	return items
}

// expandGrpcRouteRulesActionResponseHeaderModifier expands an instance of GrpcRouteRulesActionResponseHeaderModifier into a JSON
// request object.
func expandGrpcRouteRulesActionResponseHeaderModifier(c *Client, f *GrpcRouteRulesActionResponseHeaderModifier) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionResponseHeaderModifier flattens an instance of GrpcRouteRulesActionResponseHeaderModifier from a JSON
// response object.
func flattenGrpcRouteRulesActionResponseHeaderModifier(c *Client, i interface{}) *GrpcRouteRulesActionResponseHeaderModifier {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &GrpcRouteRulesActionResponseHeaderModifier{}

	if dcl.IsEmptyValueIndirect(i) {
		return EmptyGrpcRouteRulesActionResponseHeaderModifier
	}
	r.Set = dcl.FlattenKeyValuePairs(m["set"])
	r.Add = dcl.FlattenKeyValuePairs(m["add"])
	r.Remove = dcl.FlattenStringSlice(m["remove"])
...
// expandGrpcRouteRulesActionUrlRewriteMap expands the contents of GrpcRouteRulesActionUrlRewrite into a JSON
// request object.
func expandGrpcRouteRulesActionUrlRewriteMap(c *Client, f map[string]GrpcRouteRulesActionUrlRewrite) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandGrpcRouteRulesActionUrlRewrite(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandGrpcRouteRulesActionUrlRewriteSlice expands the contents of GrpcRouteRulesActionUrlRewrite into a JSON
// request object.
func expandGrpcRouteRulesActionUrlRewriteSlice(c *Client, f []GrpcRouteRulesActionUrlRewrite) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionUrlRewriteMap flattens the contents of GrpcRouteRulesActionUrlRewrite from a JSON
// response object.
func flattenGrpcRouteRulesActionUrlRewriteMap(c *Client, i interface{}) map[string]GrpcRouteRulesActionUrlRewrite {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]GrpcRouteRulesActionUrlRewrite{}
	}
	...
	items := make(map[string]GrpcRouteRulesActionUrlRewrite)
	for k, item := range a {
		items[k] = *flattenGrpcRouteRulesActionUrlRewrite(c, item.(map[string]interface{}))
	}

	return items
}

// flattenGrpcRouteRulesActionUrlRewriteSlice flattens the contents of GrpcRouteRulesActionUrlRewrite from a JSON
// response object.
func flattenGrpcRouteRulesActionUrlRewriteSlice(c *Client, i interface{}) []GrpcRouteRulesActionUrlRewrite {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]GrpcRouteRulesActionUrlRewrite, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenGrpcRouteRulesActionUrlRewrite(c, item.(map[string]interface{})))
	}

	return items
}

// expandGrpcRouteRulesActionUrlRewrite expands an instance of GrpcRouteRulesActionUrlRewrite into a JSON
// request object.
func expandGrpcRouteRulesActionUrlRewrite(c *Client, f *GrpcRouteRulesActionUrlRewrite) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionUrlRewrite flattens an instance of GrpcRouteRulesActionUrlRewrite from a JSON
// response object.
func flattenGrpcRouteRulesActionUrlRewrite(c *Client, i interface{}) *GrpcRouteRulesActionUrlRewrite {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &GrpcRouteRulesActionUrlRewrite{}

	if dcl.IsEmptyValueIndirect(i) {
		return EmptyGrpcRouteRulesActionUrlRewrite
	}
...
// expandGrpcRouteRulesActionRequestMirrorPolicyMap expands the contents of GrpcRouteRulesActionRequestMirrorPolicy into a JSON
// request object.
func expandGrpcRouteRulesActionRequestMirrorPolicyMap(c *Client, f map[string]GrpcRouteRulesActionRequestMirrorPolicy) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandGrpcRouteRulesActionRequestMirrorPolicy(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandGrpcRouteRulesActionRequestMirrorPolicySlice expands the contents of GrpcRouteRulesActionRequestMirrorPolicy into a JSON
// request object.
func expandGrpcRouteRulesActionRequestMirrorPolicySlice(c *Client, f []GrpcRouteRulesActionRequestMirrorPolicy) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionRequestMirrorPolicyMap flattens the contents of GrpcRouteRulesActionRequestMirrorPolicy from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestMirrorPolicyMap(c *Client, i interface{}) map[string]GrpcRouteRulesActionRequestMirrorPolicy {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]GrpcRouteRulesActionRequestMirrorPolicy{}
	}
	...
	items := make(map[string]GrpcRouteRulesActionRequestMirrorPolicy)
	for k, item := range a {
		items[k] = *flattenGrpcRouteRulesActionRequestMirrorPolicy(c, item.(map[string]interface{}))
	}

	return items
}

// flattenGrpcRouteRulesActionRequestMirrorPolicySlice flattens the contents of GrpcRouteRulesActionRequestMirrorPolicy from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestMirrorPolicySlice(c *Client, i interface{}) []GrpcRouteRulesActionRequestMirrorPolicy {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]GrpcRouteRulesActionRequestMirrorPolicy, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenGrpcRouteRulesActionRequestMirrorPolicy(c, item.(map[string]interface{})))
	}

	return items
}

// expandGrpcRouteRulesActionRequestMirrorPolicy expands an instance of GrpcRouteRulesActionRequestMirrorPolicy into a JSON
// request object.
func expandGrpcRouteRulesActionRequestMirrorPolicy(c *Client, f *GrpcRouteRulesActionRequestMirrorPolicy) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}

	m := make(map[string]interface{})
	if v, err := expandGrpcRouteRulesActionRequestMirrorPolicyDestination(c, f.Destination); err != nil {
...
// flattenGrpcRouteRulesActionRequestMirrorPolicy flattens an instance of GrpcRouteRulesActionRequestMirrorPolicy from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestMirrorPolicy(c *Client, i interface{}) *GrpcRouteRulesActionRequestMirrorPolicy {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &GrpcRouteRulesActionRequestMirrorPolicy{}

	if dcl.IsEmptyValueIndirect(i) {
		return EmptyGrpcRouteRulesActionRequestMirrorPolicy
	}
	r.Destination = flattenGrpcRouteRulesActionRequestMirrorPolicyDestination(c, m["destination"])

	return r
}

// expandGrpcRouteRulesActionRequestMirrorPolicyDestinationMap expands the contents of GrpcRouteRulesActionRequestMirrorPolicyDestination into a JSON
// request object.
func expandGrpcRouteRulesActionRequestMirrorPolicyDestinationMap(c *Client, f map[string]GrpcRouteRulesActionRequestMirrorPolicyDestination) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandGrpcRouteRulesActionRequestMirrorPolicyDestination(c, &item)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandGrpcRouteRulesActionRequestMirrorPolicyDestinationSlice expands the contents of GrpcRouteRulesActionRequestMirrorPolicyDestination into a JSON
// request object.
func expandGrpcRouteRulesActionRequestMirrorPolicyDestinationSlice(c *Client, f []GrpcRouteRulesActionRequestMirrorPolicyDestination) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionRequestMirrorPolicyDestinationMap flattens the contents of GrpcRouteRulesActionRequestMirrorPolicyDestination from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestMirrorPolicyDestinationMap(c *Client, i interface{}) map[string]GrpcRouteRulesActionRequestMirrorPolicyDestination {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]GrpcRouteRulesActionRequestMirrorPolicyDestination{}
	}
	...
	items := make(map[string]GrpcRouteRulesActionRequestMirrorPolicyDestination)
	for k, item := range a {
		items[k] = *flattenGrpcRouteRulesActionRequestMirrorPolicyDestination(c, item.(map[string]interface{}))
	}

	return items
}

// flattenGrpcRouteRulesActionRequestMirrorPolicyDestinationSlice flattens the contents of GrpcRouteRulesActionRequestMirrorPolicyDestination from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestMirrorPolicyDestinationSlice(c *Client, i interface{}) []GrpcRouteRulesActionRequestMirrorPolicyDestination {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]GrpcRouteRulesActionRequestMirrorPolicyDestination, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenGrpcRouteRulesActionRequestMirrorPolicyDestination(c, item.(map[string]interface{})))
	}

	return items
}

// expandGrpcRouteRulesActionRequestMirrorPolicyDestination expands an instance of GrpcRouteRulesActionRequestMirrorPolicyDestination into a JSON
// request object.
func expandGrpcRouteRulesActionRequestMirrorPolicyDestination(c *Client, f *GrpcRouteRulesActionRequestMirrorPolicyDestination) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}
...
// flattenGrpcRouteRulesActionRequestMirrorPolicyDestination flattens an instance of GrpcRouteRulesActionRequestMirrorPolicyDestination from a JSON
// response object.
func flattenGrpcRouteRulesActionRequestMirrorPolicyDestination(c *Client, i interface{}) *GrpcRouteRulesActionRequestMirrorPolicyDestination {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &GrpcRouteRulesActionRequestMirrorPolicyDestination{}
...
func extractGrpcRouteRulesActionFields(r *GrpcRoute, o *GrpcRouteRulesAction) error {
	...
	if vRequestHeaderModifier == nil {
		// note: explicitly not the empty object.
		vRequestHeaderModifier = &GrpcRouteRulesActionRequestHeaderModifier{}
	}
	if err := extractGrpcRouteRulesActionRequestHeaderModifierFields(r, vRequestHeaderModifier); err != nil {
		return err
	}
	...
	if vResponseHeaderModifier == nil {
		// note: explicitly not the empty object.
		vResponseHeaderModifier = &GrpcRouteRulesActionResponseHeaderModifier{}
	}
	if err := extractGrpcRouteRulesActionResponseHeaderModifierFields(r, vResponseHeaderModifier); err != nil {
		return err
	}
	...
	if vUrlRewrite == nil {
		// note: explicitly not the empty object.
		vUrlRewrite = &GrpcRouteRulesActionUrlRewrite{}
	}
	if err := extractGrpcRouteRulesActionUrlRewriteFields(r, vUrlRewrite); err != nil {
		return err
	}
	...
	if vRequestMirrorPolicy == nil {
		// note: explicitly not the empty object.
		vRequestMirrorPolicy = &GrpcRouteRulesActionRequestMirrorPolicy{}
	}
	if err := extractGrpcRouteRulesActionRequestMirrorPolicyFields(r, vRequestMirrorPolicy); err != nil {
		return err
	}
...
func extractGrpcRouteRulesActionRequestHeaderModifierFields(r *GrpcRoute, o *GrpcRouteRulesActionRequestHeaderModifier) error {
	return nil
}
func extractGrpcRouteRulesActionResponseHeaderModifierFields(r *GrpcRoute, o *GrpcRouteRulesActionResponseHeaderModifier) error {
	return nil
}
func extractGrpcRouteRulesActionUrlRewriteFields(r *GrpcRoute, o *GrpcRouteRulesActionUrlRewrite) error {
	return nil
}
func extractGrpcRouteRulesActionRetryPolicyFields(r *GrpcRoute, o *GrpcRouteRulesActionRetryPolicy) error {
	return nil
}
func extractGrpcRouteRulesActionRequestMirrorPolicyFields(r *GrpcRoute, o *GrpcRouteRulesActionRequestMirrorPolicy) error {
	vDestination := o.Destination
	if vDestination == nil {
		// note: explicitly not the empty object.
		vDestination = &GrpcRouteRulesActionRequestMirrorPolicyDestination{}
	}
	if err := extractGrpcRouteRulesActionRequestMirrorPolicyDestinationFields(r, vDestination); err != nil {
		return err
	}
...
func extractGrpcRouteRulesActionRequestMirrorPolicyDestinationFields(r *GrpcRoute, o *GrpcRouteRulesActionRequestMirrorPolicyDestination) error {
	return nil
}
...
func postReadExtractGrpcRouteRulesActionRequestHeaderModifierFields(r *GrpcRoute, o *GrpcRouteRulesActionRequestHeaderModifier) error {
	return nil
}
func postReadExtractGrpcRouteRulesActionResponseHeaderModifierFields(r *GrpcRoute, o *GrpcRouteRulesActionResponseHeaderModifier) error {
	return nil
}
func postReadExtractGrpcRouteRulesActionUrlRewriteFields(r *GrpcRoute, o *GrpcRouteRulesActionUrlRewrite) error {
	return nil
}
func postReadExtractGrpcRouteRulesActionRetryPolicyFields(r *GrpcRoute, o *GrpcRouteRulesActionRetryPolicy) error {
	return nil
}
func postReadExtractGrpcRouteRulesActionRequestMirrorPolicyFields(r *GrpcRoute, o *GrpcRouteRulesActionRequestMirrorPolicy) error {
	vDestination := o.Destination
	if vDestination == nil {
		// note: explicitly not the empty object.
		vDestination = &GrpcRouteRulesActionRequestMirrorPolicyDestination{}
...
func postReadExtractGrpcRouteRulesActionRequestMirrorPolicyDestinationFields(r *GrpcRoute, o *GrpcRouteRulesActionRequestMirrorPolicyDestination) error {
	return nil
}
