...
func assignmentGetURL(userBasePath string, r *Assignment) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/reservations/{{reservation}}/assignments?fetchId=%s%s", "https://bigqueryreservation.googleapis.com/v1beta1/", userBasePath, params), nil
}
...
func assignmentListURL(userBasePath, project, location, reservation string) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/reservations/{{reservation}}/assignments", "https://bigqueryreservation.googleapis.com/v1beta1/", userBasePath, params), nil
...
func assignmentDeleteURL(userBasePath string, r *Assignment) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/reservations/{{reservation}}/assignments/{{name}}", "https://bigqueryreservation.googleapis.com/v1beta1/", userBasePath, params), nil
}
