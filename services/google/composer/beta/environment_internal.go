...
func canonicalizeEnvironmentConfig(des, initial *EnvironmentConfig, opts ...dcl.ApplyOption) *EnvironmentConfig {
	...
	cDes.MaintenanceWindow = canonicalizeEnvironmentConfigMaintenanceWindow(des.MaintenanceWindow, initial.MaintenanceWindow, opts...)
...
func canonicalizeEnvironmentConfigMaintenanceWindow(des, initial *EnvironmentConfigMaintenanceWindow, opts ...dcl.ApplyOption) *EnvironmentConfigMaintenanceWindow {
	...
	cDes := &EnvironmentConfigMaintenanceWindow{}
...
func (r *Environment) updateURL(userBasePath, updateName string) (string, error) {
	...
	if updateName == "PatchEnvironment" {
		...
		return dcl.URL("projects/{{project}}/locations/{{location}}/environments/{{name}}", "https://composer.googleapis.com/v1beta2/", userBasePath, fields), nil
