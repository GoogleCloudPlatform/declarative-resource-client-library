...
func (r *EnvironmentConfigMaintenanceWindow) validate() error {
	if err := dcl.Required(r, "startTime"); err != nil {
		return err
	}
	if err := dcl.Required(r, "endTime"); err != nil {
		return err
	}
	if err := dcl.Required(r, "recurrence"); err != nil {
		return err
	}
	return nil
}
...
func environmentGetURL(userBasePath string, r *Environment) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/environments/{{name}}", "https://composer.googleapis.com/v1beta2/", userBasePath, params), nil
}
...
func environmentListURL(userBasePath, project, location string) (string, error) {
	...
	return dcl.URL("projects/{{project}}/locations/{{location}}/environments", "https://composer.googleapis.com/v1beta2/", userBasePath, params), nil
...
func (op *deleteEnvironmentOperation) do(ctx context.Context, r *Environment, c *Client) error {
	...
	if err := o.Wait(ctx, c.Config, "https://composer.googleapis.com/v1beta2/", "GET"); err != nil {
		return err
	}
...
func (c *Client) environmentDiffsForRawDesired(ctx context.Context, rawDesired *Environment, opts ...dcl.ApplyOption) (initial, desired *Environment, diffs []environmentDiff, err error) {
...
func canonicalizeEnvironmentConfig(des, initial *EnvironmentConfig, opts ...dcl.ApplyOption) *EnvironmentConfig {
	...
	des.MaintenanceWindow = canonicalizeEnvironmentConfigMaintenanceWindow(des.MaintenanceWindow, initial.MaintenanceWindow, opts...)
...
func canonicalizeNewEnvironmentConfig(c *Client, des, nw *EnvironmentConfig) *EnvironmentConfig {
	...
	nw.MaintenanceWindow = canonicalizeNewEnvironmentConfigMaintenanceWindow(c, des.MaintenanceWindow, nw.MaintenanceWindow)
...
func canonicalizeEnvironmentConfigMaintenanceWindow(des, initial *EnvironmentConfigMaintenanceWindow, opts ...dcl.ApplyOption) *EnvironmentConfigMaintenanceWindow {
	if des == nil {
		return initial
	}
	if des.empty {
...
func canonicalizeNewEnvironmentConfigMaintenanceWindow(c *Client, des, nw *EnvironmentConfigMaintenanceWindow) *EnvironmentConfigMaintenanceWindow {
	if des == nil || nw == nil {
		return nw
	}
...
func canonicalizeNewEnvironmentConfigMaintenanceWindowSet(c *Client, des, nw []EnvironmentConfigMaintenanceWindow) []EnvironmentConfigMaintenanceWindow {
	if des == nil {
		return nw
	}
	var reorderedNew []EnvironmentConfigMaintenanceWindow
	for _, d := range des {
		matchedNew := -1
		for idx, n := range nw {
			if diffs, _ := compareEnvironmentConfigMaintenanceWindowNewStyle(&d, &n, dcl.FieldName{}); len(diffs) == 0 {
				matchedNew = idx
				break
			}
		}
...
func canonicalizeNewEnvironmentConfigMaintenanceWindowSlice(c *Client, des, nw []EnvironmentConfigMaintenanceWindow) []EnvironmentConfigMaintenanceWindow {
	if des == nil {
		return nw
	}
	...
	var items []EnvironmentConfigMaintenanceWindow
	for i, d := range des {
		n := nw[i]
		items = append(items, *canonicalizeNewEnvironmentConfigMaintenanceWindow(c, &d, &n))
	}
...
func diffEnvironment(c *Client, desired, actual *Environment, opts ...dcl.ApplyOption) ([]environmentDiff, error) {
	...
	if ds, err := dcl.Diff(desired.Name, actual.Name, dcl.Info{OperationSelector: dcl.RequiresRecreate()}, fn.AddNest("Name")); len(ds) != 0 || err != nil {
		...
		dsOld, err := convertFieldDiffToEnvironmentDiff(ds, opts...)
		if err != nil {
			return nil, err
		}
...
func compareEnvironmentConfigMaintenanceWindowNewStyle(d, a interface{}, fn dcl.FieldName) ([]*dcl.FieldDiff, error) {
	var diffs []*dcl.FieldDiff

	desired, ok := d.(*EnvironmentConfigMaintenanceWindow)
	if !ok {
		desiredNotPointer, ok := d.(EnvironmentConfigMaintenanceWindow)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a EnvironmentConfigMaintenanceWindow or *EnvironmentConfigMaintenanceWindow", d)
		}
		desired = &desiredNotPointer
	}
	actual, ok := a.(*EnvironmentConfigMaintenanceWindow)
	if !ok {
		actualNotPointer, ok := a.(EnvironmentConfigMaintenanceWindow)
		if !ok {
			return nil, fmt.Errorf("obj %v is not a EnvironmentConfigMaintenanceWindow", a)
		}
		actual = &actualNotPointer
	}
...
func expandEnvironmentConfig(c *Client, f *EnvironmentConfig, res *Environment) (map[string]interface{}, error) {
	...
	if v, err := expandEnvironmentConfigMaintenanceWindow(c, f.MaintenanceWindow, res); err != nil {
...
func flattenEnvironmentConfig(c *Client, i interface{}) *EnvironmentConfig {
	...
	r.MaintenanceWindow = flattenEnvironmentConfigMaintenanceWindow(c, m["maintenanceWindow"])
...
// expandEnvironmentConfigMaintenanceWindowMap expands the contents of EnvironmentConfigMaintenanceWindow into a JSON
// request object.
func expandEnvironmentConfigMaintenanceWindowMap(c *Client, f map[string]EnvironmentConfigMaintenanceWindow, res *Environment) (map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
	...
	items := make(map[string]interface{})
	for k, item := range f {
		i, err := expandEnvironmentConfigMaintenanceWindow(c, &item, res)
		if err != nil {
			return nil, err
		}
		if i != nil {
...
// expandEnvironmentConfigMaintenanceWindowSlice expands the contents of EnvironmentConfigMaintenanceWindow into a JSON
// request object.
func expandEnvironmentConfigMaintenanceWindowSlice(c *Client, f []EnvironmentConfigMaintenanceWindow, res *Environment) ([]map[string]interface{}, error) {
	if f == nil {
		return nil, nil
	}
...
// flattenEnvironmentConfigMaintenanceWindowMap flattens the contents of EnvironmentConfigMaintenanceWindow from a JSON
// response object.
func flattenEnvironmentConfigMaintenanceWindowMap(c *Client, i interface{}) map[string]EnvironmentConfigMaintenanceWindow {
	a, ok := i.(map[string]interface{})
	if !ok {
		return map[string]EnvironmentConfigMaintenanceWindow{}
	}
	...
	items := make(map[string]EnvironmentConfigMaintenanceWindow)
	for k, item := range a {
		items[k] = *flattenEnvironmentConfigMaintenanceWindow(c, item.(map[string]interface{}))
	}

	return items
}

// flattenEnvironmentConfigMaintenanceWindowSlice flattens the contents of EnvironmentConfigMaintenanceWindow from a JSON
// response object.
func flattenEnvironmentConfigMaintenanceWindowSlice(c *Client, i interface{}) []EnvironmentConfigMaintenanceWindow {
	a, ok := i.([]interface{})
	if !ok {
	...
	items := make([]EnvironmentConfigMaintenanceWindow, 0, len(a))
	for _, item := range a {
		items = append(items, *flattenEnvironmentConfigMaintenanceWindow(c, item.(map[string]interface{})))
	}

	return items
}

// expandEnvironmentConfigMaintenanceWindow expands an instance of EnvironmentConfigMaintenanceWindow into a JSON
// request object.
func expandEnvironmentConfigMaintenanceWindow(c *Client, f *EnvironmentConfigMaintenanceWindow, res *Environment) (map[string]interface{}, error) {
	if dcl.IsEmptyValueIndirect(f) {
		return nil, nil
	}
...
// flattenEnvironmentConfigMaintenanceWindow flattens an instance of EnvironmentConfigMaintenanceWindow from a JSON
// response object.
func flattenEnvironmentConfigMaintenanceWindow(c *Client, i interface{}) *EnvironmentConfigMaintenanceWindow {
	m, ok := i.(map[string]interface{})
	if !ok {
		return nil
	}

	r := &EnvironmentConfigMaintenanceWindow{}

	if dcl.IsEmptyValueIndirect(i) {
		return EmptyEnvironmentConfigMaintenanceWindow
	}
...
func convertFieldDiffToEnvironmentDiff(fds []*dcl.FieldDiff, opts ...dcl.ApplyOption) ([]environmentDiff, error) {
	var diffs []environmentDiff
	for _, fd := range fds {
		for _, op := range fd.ResultingOperation {
			diff := environmentDiff{Diffs: []*dcl.FieldDiff{fd}, FieldName: fd.FieldName}
			if op == "Recreate" {
				diff.RequiresRecreate = true
			} else {
				op, err := convertOpNameToenvironmentApiOperation(op, opts...)
				if err != nil {
					return nil, err
				}
				diff.UpdateOp = op
...
func convertOpNameToenvironmentApiOperation(op string, opts ...dcl.ApplyOption) (environmentApiOperation, error) {
	switch op {
