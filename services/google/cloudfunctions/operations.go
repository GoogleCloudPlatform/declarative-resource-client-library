...
// Package cloudfunctions contains handwritten support code for the cloud functions service.
...
func (op *Operation) operate(ctx context.Context) (*dcl.RetryDetails, error) {
	u := dcl.URL(op.Name, "https://cloudfunctions.googleapis.com/v1/", op.config.BasePath, nil)
