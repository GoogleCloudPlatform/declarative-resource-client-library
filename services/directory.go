...
func Services() *Directory {
	...
	d.AddResource("beta", "compute", dcl.TitleToSnakeCase("Interconnect"), compute_beta.YAML_interconnect)
	d.AddResource("beta", "compute", "Interconnect", compute_beta.YAML_interconnect)
	...
	d.AddResource("alpha", "compute", dcl.TitleToSnakeCase("Interconnect"), compute_alpha.YAML_interconnect)
	d.AddResource("alpha", "compute", "Interconnect", compute_alpha.YAML_interconnect)
