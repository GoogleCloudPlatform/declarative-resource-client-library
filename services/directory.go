...
import (
	...
	vertexai_alpha "github.com/GoogleCloudPlatform/declarative-resource-client-library/services/google/vertexai/alpha"
	vertexai_beta "github.com/GoogleCloudPlatform/declarative-resource-client-library/services/google/vertexai/beta"
...
func Services() *Directory {
	...
	d.AddResource("ga", "vertexai", dcl.TitleToSnakeCase("Endpoint"), vertexai.YAML_endpoint)
	d.AddResource("ga", "vertexai", "Endpoint", vertexai.YAML_endpoint)
	d.AddResource("ga", "vertexai", dcl.TitleToSnakeCase("EndpointTrafficSplit"), vertexai.YAML_endpoint_traffic_split)
	d.AddResource("ga", "vertexai", "EndpointTrafficSplit", vertexai.YAML_endpoint_traffic_split)
	d.AddResource("ga", "vertexai", dcl.TitleToSnakeCase("MetadataSchema"), vertexai.YAML_metadata_schema)
	d.AddResource("ga", "vertexai", "MetadataSchema", vertexai.YAML_metadata_schema)
	d.AddResource("ga", "vertexai", dcl.TitleToSnakeCase("MetadataStore"), vertexai.YAML_metadata_store)
	d.AddResource("ga", "vertexai", "MetadataStore", vertexai.YAML_metadata_store)
	d.AddResource("ga", "vertexai", dcl.TitleToSnakeCase("Model"), vertexai.YAML_model)
	d.AddResource("ga", "vertexai", "Model", vertexai.YAML_model)
	d.AddResource("ga", "vertexai", dcl.TitleToSnakeCase("ModelDeployment"), vertexai.YAML_model_deployment)
	d.AddResource("ga", "vertexai", "ModelDeployment", vertexai.YAML_model_deployment)
	...
	d.AddResource("beta", "vertexai", dcl.TitleToSnakeCase("Endpoint"), vertexai_beta.YAML_endpoint)
	d.AddResource("beta", "vertexai", "Endpoint", vertexai_beta.YAML_endpoint)
	d.AddResource("beta", "vertexai", dcl.TitleToSnakeCase("EndpointTrafficSplit"), vertexai_beta.YAML_endpoint_traffic_split)
	d.AddResource("beta", "vertexai", "EndpointTrafficSplit", vertexai_beta.YAML_endpoint_traffic_split)
	d.AddResource("beta", "vertexai", dcl.TitleToSnakeCase("MetadataSchema"), vertexai_beta.YAML_metadata_schema)
	d.AddResource("beta", "vertexai", "MetadataSchema", vertexai_beta.YAML_metadata_schema)
	d.AddResource("beta", "vertexai", dcl.TitleToSnakeCase("MetadataStore"), vertexai_beta.YAML_metadata_store)
	d.AddResource("beta", "vertexai", "MetadataStore", vertexai_beta.YAML_metadata_store)
	d.AddResource("beta", "vertexai", dcl.TitleToSnakeCase("Model"), vertexai_beta.YAML_model)
	d.AddResource("beta", "vertexai", "Model", vertexai_beta.YAML_model)
	d.AddResource("beta", "vertexai", dcl.TitleToSnakeCase("ModelDeployment"), vertexai_beta.YAML_model_deployment)
	d.AddResource("beta", "vertexai", "ModelDeployment", vertexai_beta.YAML_model_deployment)
	...
	d.AddResource("alpha", "vertexai", dcl.TitleToSnakeCase("Endpoint"), vertexai_alpha.YAML_endpoint)
	d.AddResource("alpha", "vertexai", "Endpoint", vertexai_alpha.YAML_endpoint)
	d.AddResource("alpha", "vertexai", dcl.TitleToSnakeCase("EndpointTrafficSplit"), vertexai_alpha.YAML_endpoint_traffic_split)
	d.AddResource("alpha", "vertexai", "EndpointTrafficSplit", vertexai_alpha.YAML_endpoint_traffic_split)
	d.AddResource("alpha", "vertexai", dcl.TitleToSnakeCase("MetadataSchema"), vertexai_alpha.YAML_metadata_schema)
	d.AddResource("alpha", "vertexai", "MetadataSchema", vertexai_alpha.YAML_metadata_schema)
	d.AddResource("alpha", "vertexai", dcl.TitleToSnakeCase("MetadataStore"), vertexai_alpha.YAML_metadata_store)
	d.AddResource("alpha", "vertexai", "MetadataStore", vertexai_alpha.YAML_metadata_store)
	d.AddResource("alpha", "vertexai", dcl.TitleToSnakeCase("Model"), vertexai_alpha.YAML_model)
	d.AddResource("alpha", "vertexai", "Model", vertexai_alpha.YAML_model)
	d.AddResource("alpha", "vertexai", dcl.TitleToSnakeCase("ModelDeployment"), vertexai_alpha.YAML_model_deployment)
	d.AddResource("alpha", "vertexai", "ModelDeployment", vertexai_alpha.YAML_model_deployment)
