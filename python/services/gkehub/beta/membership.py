...
from google3.cloud.graphite.mmv2.services.google.gkehub import membership_pb2
from google3.cloud.graphite.mmv2.services.google.gkehub import membership_pb2_grpc
...
class Membership(object):
    ...
    def from_any(self, any_proto):
        ...
        res_proto = membership_pb2.GkehubBetaMembership()
        any_proto.Unpack(res_proto)

        res = Membership()
        res.endpoint = MembershipEndpoint.from_proto(res_proto.endpoint)
        res.name = Primitive.from_proto(res_proto.name)
        res.labels = Primitive.from_proto(res_proto.labels)
        res.description = Primitive.from_proto(res_proto.description)
        res.state = MembershipState.from_proto(res_proto.state)
        ...
        res.external_id = Primitive.from_proto(res_proto.external_id)
        res.last_connection_time = Primitive.from_proto(res_proto.last_connection_time)
        res.unique_id = Primitive.from_proto(res_proto.unique_id)
        res.authority = MembershipAuthority.from_proto(res_proto.authority)
        res.infrastructure_type = MembershipInfrastructureTypeEnum.from_proto(
            res_proto.infrastructure_type
        )
