...
class WorkloadWorkloadOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = workload_pb2.AssuredworkloadsBetaWorkloadWorkloadOptions()
...
class WorkloadWorkloadOptionsKajEnrollmentTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsBetaWorkloadWorkloadOptionsKajEnrollmentTypeEnum.Value(
            "AssuredworkloadsBetaWorkloadWorkloadOptionsKajEnrollmentTypeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsBetaWorkloadWorkloadOptionsKajEnrollmentTypeEnum.Name(
            resource
        )[
            len("AssuredworkloadsBetaWorkloadWorkloadOptionsKajEnrollmentTypeEnum") :
        ]
