...
class WorkloadWorkloadOptions(object):
    ...
    def to_proto(self, resource):
        ...
        res = workload_pb2.AssuredworkloadsWorkloadWorkloadOptions()
...
class WorkloadWorkloadOptionsKajEnrollmentTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsWorkloadWorkloadOptionsKajEnrollmentTypeEnum.Value(
            "AssuredworkloadsWorkloadWorkloadOptionsKajEnrollmentTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return workload_pb2.AssuredworkloadsWorkloadWorkloadOptionsKajEnrollmentTypeEnum.Name(
            resource
        )[
            len("AssuredworkloadsWorkloadWorkloadOptionsKajEnrollmentTypeEnum") :
        ]
