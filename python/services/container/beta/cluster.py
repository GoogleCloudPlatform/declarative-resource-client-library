...
class Cluster(object):
    ...
    def from_any(self, any_proto):
        ...
        res_proto = cluster_pb2.ContainerBetaCluster()
        ...
        res.node_config = ClusterNodeConfig.from_proto(res_proto.node_config)
        res.release_channel = ClusterReleaseChannel.from_proto(
            res_proto.release_channel
        )
        res.workload_identity_config = ClusterWorkloadIdentityConfig.from_proto(
            res_proto.workload_identity_config
        )
        res.notification_config = ClusterNotificationConfig.from_proto(
            res_proto.notification_config
        )
        res.confidential_nodes = ClusterConfidentialNodes.from_proto(
            res_proto.confidential_nodes
        )
        res.self_link = Primitive.from_proto(res_proto.self_link)
        res.zone = Primitive.from_proto(res_proto.zone)
        res.initial_cluster_version = Primitive.from_proto(
            res_proto.initial_cluster_version
        )
        res.current_master_version = Primitive.from_proto(
            res_proto.current_master_version
        )
        res.current_node_version = Primitive.from_proto(res_proto.current_node_version)
        res.instance_group_urls = Primitive.from_proto(res_proto.instance_group_urls)
        res.current_node_count = Primitive.from_proto(res_proto.current_node_count)
        res.id = Primitive.from_proto(res_proto.id)
        res.pod_security_policy_config = ClusterPodSecurityPolicyConfig.from_proto(
            res_proto.pod_security_policy_config
        )
        res.private_cluster = Primitive.from_proto(res_proto.private_cluster)
        res.master_ipv4_cidr_block = Primitive.from_proto(
            res_proto.master_ipv4_cidr_block
        )
        res.cluster_telemetry = ClusterClusterTelemetry.from_proto(
            res_proto.cluster_telemetry
        )
        res.tpu_config = ClusterTPUConfig.from_proto(res_proto.tpu_config)
        res.master = ClusterMaster.from_proto(res_proto.master)
        return res
...
class ClusterAddonsConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterAddonsConfig(
            ...
            istio_config=resource.istio_config,
            kalm_config=resource.kalm_config,
        )
...
class ClusterAddonsConfigIstioConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterAddonsConfigIstioConfig(
            disabled=resource.disabled, auth=resource.auth,
        )
...
class ClusterAddonsConfigKalmConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterAddonsConfigKalmConfig(enabled=resource.enabled,)
...
class ClusterNodePoolsConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterNodePoolsConfig(
            ...
            ephemeral_storage_config=resource.ephemeral_storage_config,
        )
...
class ClusterNodePoolsConfigWorkloadMetadataConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterNodePoolsConfigWorkloadMetadataConfig(
            mode=resource.mode, node_metadata=resource.node_metadata,
        )
...
class ClusterNodePoolsConfigSandboxConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterNodePoolsConfigSandboxConfig(
            type=resource.type, sandbox_type=resource.sandbox_type,
        )
...
class ClusterNodePoolsNetworkConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterNodePoolsNetworkConfig(
            create_pod_range=resource.create_pod_range,
            pod_range=resource.pod_range,
            pod_ipv4_cidr_block=resource.pod_ipv4_cidr_block,
        )
...
class ClusterIPAllocationPolicy(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterIPAllocationPolicy(
            ...
            allow_route_overlap=resource.allow_route_overlap,
        )
...
class ClusterAutoscaling(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterAutoscaling(
            ...
            autoscaling_profile=resource.autoscaling_profile,
        )
...
class ClusterNetworkConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterNetworkConfig(
            ...
            datapath_provider=resource.datapath_provider,
        )
...
class ClusterVerticalPodAutoscaling(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterVerticalPodAutoscaling(
            enabled=resource.enabled,
            enable_experimental_features=resource.enable_experimental_features,
        )
...
class ClusterWorkloadIdentityConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterWorkloadIdentityConfig(
            workload_pool=resource.workload_pool,
            identity_namespace=resource.identity_namespace,
...
class ClusterPodSecurityPolicyConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterPodSecurityPolicyConfig(enabled=resource.enabled,)
...
class ClusterClusterTelemetry(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterClusterTelemetry(type=resource.type,)
...
class ClusterTPUConfig(object):
    ...
    def from_proto(self, resource):
        ...
        return ClusterTPUConfig(
            enabled=resource.enabled,
            use_service_networking=resource.use_service_networking,
            ipv4_cidr_block=resource.ipv4_cidr_block,
        )
