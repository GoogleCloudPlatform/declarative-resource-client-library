...
func ProtoToEventarcBetaTriggerDestination(p *betapb.EventarcBetaTriggerDestination) *beta.TriggerDestination {
	...
	obj := &beta.TriggerDestination{
		CloudRun:      ProtoToEventarcBetaTriggerDestinationCloudRun(p.GetCloudRun()),
...
func ProtoToEventarcBetaTriggerDestinationCloudRun(p *betapb.EventarcBetaTriggerDestinationCloudRun) *beta.TriggerDestinationCloudRun {
	if p == nil {
		return nil
	}
	obj := &beta.TriggerDestinationCloudRun{
...
func EventarcBetaTriggerDestinationToProto(o *beta.TriggerDestination) *betapb.EventarcBetaTriggerDestination {
	...
	p.SetCloudRun(EventarcBetaTriggerDestinationCloudRunToProto(o.CloudRun))
...
func EventarcBetaTriggerDestinationCloudRunToProto(o *beta.TriggerDestinationCloudRun) *betapb.EventarcBetaTriggerDestinationCloudRun {
	if o == nil {
		return nil
	}
	p := &betapb.EventarcBetaTriggerDestinationCloudRun{}
