...
class InterconnectAttachmentTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentTypeEnum.Value(
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentTypeEnum.Name(
            resource
        )[
...
class InterconnectAttachmentStateEnum(object):
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return interconnect_attachment_pb2.ComputeBetaInterconnectAttachmentStateEnum.Name(
            resource
        )[
