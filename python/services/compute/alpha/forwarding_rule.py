...
class ForwardingRuleLoadBalancingSchemeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleLoadBalancingSchemeEnum.Value(
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return forwarding_rule_pb2.ComputeAlphaForwardingRuleLoadBalancingSchemeEnum.Name(
            resource
        )[
