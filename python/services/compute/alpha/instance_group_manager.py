...
class InstanceGroupManager(object):
    ...
    def apply(self):
        stub = instance_group_manager_pb2_grpc.ComputeAlphaInstanceGroupManagerServiceStub(
            channel.Channel()
        )
        request = (
...
class InstanceGroupManagerFixedOrPercent(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            instance_group_manager_pb2.ComputeAlphaInstanceGroupManagerFixedOrPercent()
        )
