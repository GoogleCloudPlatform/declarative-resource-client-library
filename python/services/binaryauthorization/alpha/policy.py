...
class PolicyAdmissionRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = policy_pb2.BinaryauthorizationAlphaPolicyAdmissionRule()
...
class PolicyAdmissionRuleEvaluationModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return policy_pb2.BinaryauthorizationAlphaPolicyAdmissionRuleEvaluationModeEnum.Value(
            "BinaryauthorizationAlphaPolicyAdmissionRuleEvaluationModeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return policy_pb2.BinaryauthorizationAlphaPolicyAdmissionRuleEvaluationModeEnum.Name(
            resource
        )[
            len("BinaryauthorizationAlphaPolicyAdmissionRuleEvaluationModeEnum") :
        ]
...
class PolicyAdmissionRuleEnforcementModeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return policy_pb2.BinaryauthorizationAlphaPolicyAdmissionRuleEnforcementModeEnum.Value(
            "BinaryauthorizationAlphaPolicyAdmissionRuleEnforcementModeEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return policy_pb2.BinaryauthorizationAlphaPolicyAdmissionRuleEnforcementModeEnum.Name(
            resource
        )[
            len("BinaryauthorizationAlphaPolicyAdmissionRuleEnforcementModeEnum") :
        ]
