...
func ProtoToDataprocBetaWorkflowTemplateEncryptionConfig(p *betapb.DataprocBetaWorkflowTemplateEncryptionConfig) *beta.WorkflowTemplateEncryptionConfig {
	if p == nil {
		return nil
	}
	obj := &beta.WorkflowTemplateEncryptionConfig{
...
func ProtoToWorkflowTemplate(p *betapb.DataprocBetaWorkflowTemplate) *beta.WorkflowTemplate {
	obj := &beta.WorkflowTemplate{
		...
		EncryptionConfig: ProtoToDataprocBetaWorkflowTemplateEncryptionConfig(p.GetEncryptionConfig()),
...
func DataprocBetaWorkflowTemplateEncryptionConfigToProto(o *beta.WorkflowTemplateEncryptionConfig) *betapb.DataprocBetaWorkflowTemplateEncryptionConfig {
	if o == nil {
		return nil
	}
	p := &betapb.DataprocBetaWorkflowTemplateEncryptionConfig{}
...
func WorkflowTemplateToProto(resource *beta.WorkflowTemplate) *betapb.DataprocBetaWorkflowTemplate {
	...
	p.SetEncryptionConfig(DataprocBetaWorkflowTemplateEncryptionConfigToProto(resource.EncryptionConfig))
