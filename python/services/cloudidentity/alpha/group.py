...
class GroupGoogleappscloudidentitygroupsvxentitykey(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            group_pb2.CloudidentityAlphaGroupGoogleappscloudidentitygroupsvxentitykey()
        )
...
class GroupDynamicGroupMetadataStatusStatusEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityAlphaGroupDynamicGroupMetadataStatusStatusEnum.Value(
            "CloudidentityAlphaGroupDynamicGroupMetadataStatusStatusEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return group_pb2.CloudidentityAlphaGroupDynamicGroupMetadataStatusStatusEnum.Name(
            resource
        )[
