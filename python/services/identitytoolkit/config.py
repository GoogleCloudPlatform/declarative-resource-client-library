...
class ConfigEmailTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitConfigEmailTemplate()
...
class ConfigEmailTemplateBodyFormatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigEmailTemplateBodyFormatEnum.Value(
            "IdentitytoolkitConfigEmailTemplateBodyFormatEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitConfigEmailTemplateBodyFormatEnum.Name(
            resource
        )[len("IdentitytoolkitConfigEmailTemplateBodyFormatEnum") :]
