...
class ConfigNotificationSendEmailMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailMethodEnum.Value(
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitAlphaConfigNotificationSendEmailMethodEnum.Name(
            resource
        )[
