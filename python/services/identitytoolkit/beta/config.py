...
class ConfigEmailTemplate(object):
    ...
    def to_proto(self, resource):
        ...
        res = config_pb2.IdentitytoolkitBetaConfigEmailTemplate()
...
class ConfigSignInEmailHashConfigAlgorithmEnum(object):
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitBetaConfigSignInEmailHashConfigAlgorithmEnum.Name(
            resource
        )[
...
class ConfigNotificationSendEmailMethodEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitBetaConfigNotificationSendEmailMethodEnum.Value(
...
class ConfigEmailTemplateBodyFormatEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitBetaConfigEmailTemplateBodyFormatEnum.Value(
            "IdentitytoolkitBetaConfigEmailTemplateBodyFormatEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return config_pb2.IdentitytoolkitBetaConfigEmailTemplateBodyFormatEnum.Name(
            resource
        )[len("IdentitytoolkitBetaConfigEmailTemplateBodyFormatEnum") :]
