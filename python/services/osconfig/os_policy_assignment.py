...
class OSPolicyAssignmentFile(object):
    ...
    def to_proto(self, resource):
        ...
        res = os_policy_assignment_pb2.OsconfigOSPolicyAssignmentFile()
...
class OSPolicyAssignmentFileRemote(object):
    ...
    def to_proto(self, resource):
        ...
        res = os_policy_assignment_pb2.OsconfigOSPolicyAssignmentFileRemote()
...
class OSPolicyAssignmentFileGcs(object):
    ...
    def to_proto(self, resource):
        ...
        res = os_policy_assignment_pb2.OsconfigOSPolicyAssignmentFileGcs()
...
class OSPolicyAssignmentExec(object):
    ...
    def to_proto(self, resource):
        ...
        res = os_policy_assignment_pb2.OsconfigOSPolicyAssignmentExec()
...
class OSPolicyAssignmentExecInterpreterEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return os_policy_assignment_pb2.OsconfigOSPolicyAssignmentExecInterpreterEnum.Value(
            "OsconfigOSPolicyAssignmentExecInterpreterEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return os_policy_assignment_pb2.OsconfigOSPolicyAssignmentExecInterpreterEnum.Name(
            resource
        )[
            len("OsconfigOSPolicyAssignmentExecInterpreterEnum") :
        ]
