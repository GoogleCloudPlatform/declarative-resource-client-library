...
class ModelContainerSpecAcceleratorRequirements(object):
    ...
    def to_proto(self, resource):
        ...
        res = model_pb2.VertexaiBetaModelContainerSpecAcceleratorRequirements()
...
class ModelContainerSpecAcceleratorRequirementsTypeEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexaiBetaModelContainerSpecAcceleratorRequirementsTypeEnum.Value(
            "VertexaiBetaModelContainerSpecAcceleratorRequirementsTypeEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return model_pb2.VertexaiBetaModelContainerSpecAcceleratorRequirementsTypeEnum.Name(
            resource
        )[
            len("VertexaiBetaModelContainerSpecAcceleratorRequirementsTypeEnum") :
        ]
