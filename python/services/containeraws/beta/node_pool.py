...
class NodePoolKubeletConfig(object):
    ...
    def to_proto(self, resource):
        ...
        res = node_pool_pb2.ContainerawsBetaNodePoolKubeletConfig()
...
class NodePoolKubeletConfigCpuManagerPolicyEnum(object):
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolKubeletConfigCpuManagerPolicyEnum.Value(
            "ContainerawsBetaNodePoolKubeletConfigCpuManagerPolicyEnum%s" % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return node_pool_pb2.ContainerawsBetaNodePoolKubeletConfigCpuManagerPolicyEnum.Name(
            resource
        )[
            len("ContainerawsBetaNodePoolKubeletConfigCpuManagerPolicyEnum") :
        ]
