...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRules()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRule()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleHotwordRegex(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleHotwordRegex()
        )
        if Primitive.to_proto(resource.pattern):
            res.pattern = Primitive.to_proto(resource.pattern)
        if int64Array.to_proto(resource.group_indexes):
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleProximity(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleProximity()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustment(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustment()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Value(
            "DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Name(
            resource
        )[
            len(
                "DlpAlphaInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum"
            ) :
        ]
