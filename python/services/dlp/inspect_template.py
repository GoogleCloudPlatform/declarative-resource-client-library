...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRules(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRules()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRule(object):
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRule()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleHotwordRegex(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleHotwordRegex()
        )
        if Primitive.to_proto(resource.pattern):
            res.pattern = Primitive.to_proto(resource.pattern)
        if int64Array.to_proto(resource.group_indexes):
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleProximity(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleProximity()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustment(
    ...
    def to_proto(self, resource):
        ...
        res = (
            inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustment()
        )
...
class InspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum(
    ...
    def to_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Value(
            "DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum%s"
            % resource
        )
    ...
    def from_proto(self, resource):
        if not resource:
            return resource
        return inspect_template_pb2.DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum.Name(
            resource
        )[
            len(
                "DlpInspectTemplateInspectConfigCustomInfoTypesDetectionRulesHotwordRuleLikelihoodAdjustmentFixedLikelihoodEnum"
            ) :
        ]
